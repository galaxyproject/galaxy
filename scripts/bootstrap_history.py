...
- [ ] **Branch Release (on or around ${freeze_date})**
    ...
    - [ ] Open PR against ``release_${version}`` branch to pin flake8 deps in tox.ini to the latest available version. You can use `make pin-linting`. See [example](https://github.com/galaxyproject/galaxy/pull/3476).
