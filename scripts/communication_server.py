...
<body style="overflow: hidden";> 
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        // socketio events
        var events_module = {
            // event handler for sending data from server
        ...
        var utils = {
            ...
            build_message: function(original_message, uid) {
                ...
                message_text = "<div class='user_message'> <i class='fa fa-quote-left' aria-hidden='true'></i> " +
                                unescape( original_message[0] ) + " <i class='fa fa-quote-right' aria-hidden='true'></i><div class='date_time'><span>sent on " +
                                this.get_date_time() + "</span></div></div>";
