...
def verify_irods_checksum(start_dataset_id, end_dataset_id, object_store_info_file, irods_info_file, db_connection_info_file):
    conn = None
    session = None
    osi_keys = None
...
def print_help_msg():
    ...
    print("verify_irods_checksum --start_dataset_id=2 --end_dataset_id=3 --object_store_info_file=object_store_info.json --irods_info_file=irods_info_file.json --db_connection_info_file=db_connection_info_file.json")
    print("\nOR")
    print("\nShort form input parameter specification:")
    print("verify_irods_checksum -s 2 -e 3 -o object_store_info.json -i irods_info_file.json -d db_connection_info_file.json")
    print("\n")
...
if __name__ == '__main__':
    ...
    verify_irods_checksum(start_dataset_id=start_dataset_id, end_dataset_id=end_dataset_id, object_store_info_file=object_store_info_file, irods_info_file=irods_info_file, db_connection_info_file=db_connection_info_file)
