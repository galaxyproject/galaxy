...
define({
    ...
    "An error occurred while getting updates from the server": "Ein Fehler ist aufgetreten beim Aktualisieren vom Server",
    "Please contact a Galaxy administrator if the problem persists": "Bitte wenden Sie sich an einen Galaxy-Administrator, wenn das Problem weiterhin besteht",
    //TODO:
    ...
    "Tool execution is on hold until your disk usage drops below your allocated quota": "Tool-Ausführung ist in der Warteschleife, bis Ihre Datenträgerverwendung unter Ihrem zugeteilten Kontingent fällt",
    All: "Alle",
    None: "Keiner",
    ...
    "This will permanently remove the data in your datasets. Are you sure?": "Das wird endgültig die Daten in deinen Datasets entfernen. Bist du sicher?",
    // ---- history-view-annotated
    Dataset: "Dataset",
    Annotation: "Annotation",
    // ---- history-view-edit-current
    "This history is empty. Click 'Get Data' on the left tool menu to start": "Diese Geschichte ist leer. Klicken Sie auf 'Get Data' im linken Tool-Menü, um",
    ...
    "This dataset must finish uploading before it can be viewed": "Dieser Datensatz muss das Hochladen beenden, bevor es angezeigt werden kann",
    ...
    // dataset states
    // state: new
    "This is a new dataset and not all of its data are available yet": "Dies ist ein neuer Datensatz und nicht alle seine Daten sind noch verfügbar",
    // state: noPermission
    "You do not have permission to view this dataset": "Sie haben keine Berechtigung, diesen Datensatz anzuzeigen",
    // state: discarded
    "The job creating this dataset was cancelled before completion": "Der Job, der diesen Datensatz erstellt hat, wurde vor der Fertigstellung abgebrochen",
    // state: queued
    ...
    // state: paused
    'This job is paused. Use the "Resume Paused Jobs" in the history menu to resume': 'Dieser Job wird pausiert. Verwenden Sie die "Resume Paused Jobs " im Verlaufsmenü, um',
    // state: error
    "An error occurred with this dataset": "Ein Fehler ist mit diesem Datensatz aufgetreten",
    // state: empty
    "No data": "Keine Daten",
    // state: failed_metadata
    "An error occurred setting the metadata for this dataset": "Ein Fehler ist aufgetreten Einstellung der Metadaten für diese Datenmenge",
    // ajax error prefix
    "There was an error getting the data for this dataset": "Es gab einen Fehler, der die Daten für diesen Datensatz bekam",
    // purged'd/del'd msg
    "This dataset has been deleted and removed from disk": "Dieser Datensatz wurde gelöscht und von der Festplatte entfernt",
    ...
    "Cannot edit attributes of datasets removed from disk": "Kann keine Attribute von Datasets aus dem Datenträger entfernen",
    "Undelete dataset to edit attributes": "Undelete-Dataset zum Bearbeiten von Attributen",
    "This dataset must finish uploading before it can be edited": "Dieser Datensatz muss das Hochladen beenden, bevor es bearbeitet werden kann",
...
//# sourceMappingURL=../../../maps/nls/de/locale.js.map
