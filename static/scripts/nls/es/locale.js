...
define({
    ...
    "An error occurred while getting updates from the server": "Se ha producido un error al obtener actualizaciones desde el servidor",
    "Please contact a Galaxy administrator if the problem persists": "Póngase en contacto con un administrador de Galaxy si el problema persiste",
    //TODO:
    ...
    "Tool execution is on hold until your disk usage drops below your allocated quota": "La ejecución de la herramienta está en espera hasta que el uso del disco caiga por debajo de la cuota asignada",
    All: "Todas",
    None: "Ninguna",
    ...
    "This will permanently remove the data in your datasets. Are you sure?": "Esto eliminará permanentemente los datos de sus datasets. ¿Está seguro?",
    // ---- history-view-annotated
    Dataset: "Conjunto de datos",
    Annotation: "Anotación",
    // ---- history-view-edit-current
    "This history is empty. Click 'Get Data' on the left tool menu to start": "Este historial está vacío. Haga clic en 'Obtener datos' en el menú de herramientas de la izquierda para iniciar",
    ...
    "This dataset must finish uploading before it can be viewed": "Este conjunto de datos debe terminar de cargar antes de que se pueda ver",
    ...
    // dataset states
    // state: new
    "This is a new dataset and not all of its data are available yet": "Este es un nuevo conjunto de datos y no todos sus datos están disponibles todavía",
    // state: noPermission
    "You do not have permission to view this dataset": "No tiene permiso para ver este conjunto de datos",
    // state: discarded
    "The job creating this dataset was cancelled before completion": "El trabajo que creó este conjunto de datos se canceló antes de completarse",
    // state: queued
    ...
    // state: paused
    'This job is paused. Use the "Resume Paused Jobs" in the history menu to resume': 'Este trabajo está en pausa Utilice la opción " Reanudar pausado Jobs " en el menú de historial para reanudar',
    // state: error
    "An error occurred with this dataset": "Se ha producido un error con este conjunto de datos",
    // state: empty
    "No data": "Sin datos",
    // state: failed_metadata
    "An error occurred setting the metadata for this dataset": "Se ha producido un error al establecer los metadatos de este conjunto de datos",
    // ajax error prefix
    "There was an error getting the data for this dataset": "Hubo un error al obtener los datos de este conjunto de datos",
    // purged'd/del'd msg
    "This dataset has been deleted and removed from disk": "Este conjunto de datos ha sido eliminado y eliminado del disco",
    ...
    "Cannot edit attributes of datasets removed from disk": "No se pueden editar los atributos de conjuntos de datos eliminados del disco",
    "Undelete dataset to edit attributes": "Undelete el conjunto de datos para editar atributos",
    "This dataset must finish uploading before it can be edited": "Este conjunto de datos debe terminar de cargar antes de que pueda ser editado",
...
//# sourceMappingURL=../../../maps/nls/es/locale.js.map
