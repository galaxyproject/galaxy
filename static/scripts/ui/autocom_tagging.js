define("ui/autocom_tagging", ["exports", "jquery"], function(exports, _jquery) {
    "use strict";
    ...
    _jquery2.default.fn.autocomplete_tagging = function(options) {
        var defaults = {
            get_toggle_link_text_fn: function get_toggle_link_text_fn(tags) {
                var text = "";
            ...
            tag_click_fn: function tag_click_fn(name, value) {},
            editable: true,
            input_size: 20,
            in_form: false,
            tags: {},
        ...
        toggle_link.click(function() {
            ...
            if (tag_area.is(":hidden")) {
                after_toggle_fn = function after_toggle_fn() {
        ...
        var format_item_func = function format_item_func(key, row_position, num_rows, value, search_term) {
        ...
        if (settings.editable) {
            ...
            tag_area.click(function(e) {
                ...
                var handle_document_click = function handle_document_click(e) {
                    var check_click = function check_click(tag_area, target) {
    ...
    // ============================================================================
    exports.default = init_tag_click_function;
});
