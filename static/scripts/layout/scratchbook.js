define("layout/scratchbook", ["exports", "mvc/ui/ui-frames", "mvc/dataset/data", "viz/visualization", "viz/trackster", "utils/localization"], function(exports, _uiFrames, _data, _visualization, _trackster, _localization) {
    "use strict";
    ...
    exports.default = Backbone.View.extend({
        initialize: function initialize(options) {
            var self = this;
            options = options || {};
            this.frames = new _uiFrames2.default.View({
                visible: false
            });
            ...
            this._loadDataset(dataset_id, function(dataset, config) {
                ...
                self.add(_.extend({
                    menu: [{
                        ...
                        tooltip: (0, _localization2.default)("Previous in History"),
                        ...
                        tooltip: (0, _localization2.default)("Next in History"),
                        onclick: function onclick(frame) {
                            _loadDatasetOffset(current_dataset, 1, frame);
                        },
                        disabled: function disabled() {
        ...
        _loadDataset: function _loadDataset(dataset_id, callback) {
            var self = this;
            var dataset = new _data2.default.Dataset({
                id: dataset_id
            });
        ...
        addTrackster: function addTrackster(viz_id) {
            var self = this;
            var viz = new _visualization2.default.Visualization({
                id: viz_id
            });
