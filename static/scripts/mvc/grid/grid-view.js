define("mvc/grid/grid-view", ["exports", "utils/utils", "mvc/grid/grid-model", "mvc/grid/grid-template", "mvc/ui/popup-menu"], function(exports, _utils, _gridModel, _gridTemplate, _popupMenu) {
    "use strict";
