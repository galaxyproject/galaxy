define("mvc/workflow/workflow-view", ["exports", "utils/localization", "utils/utils", "mvc/workflow/workflow-manager", "mvc/workflow/workflow-canvas", "mvc/workflow/workflow-node", "mvc/workflow/workflow-icons", "mvc/workflow/workflow-forms", "mvc/ui/ui-misc", "utils/async-save-text", "libs/toastr", "ui/editable-text"], function(exports, _localization, _utils, _workflowManager, _workflowCanvas, _workflowNode, _workflowIcons, _workflowForms, _uiMisc, _asyncSaveText, _toastr) {
    "use strict";
    ...
    exports.default = Backbone.View.extend({
        initialize: function initialize(options) {
            ...
            var save_current_workflow = function save_current_workflow(eventObj, success_callback) {
                ...
                _utils2.default.request({
                    ...
                    type: "PUT",
                    data: {
                        workflow: self.workflow.to_simple()
                    },
                    ...
                    error: function error(response) {
                        window.show_modal("Saving workflow failed.", response.err_msg, {
                            Ok: hide_modal
                        });
                    }
                });
            ...
            this._workflowLoadAjax(self.options.id, {
                success: function success(data) {
                    ...
                    if (upgrade_message) {
                        window.show_modal("Issues loading this workflow", "Please review the following issues, possibly resulting from tool upgrades or changes.<p><ul>" + upgrade_message + "</ul></p>", {
                            Continue: hide_modal
                        });
                    } else {
                        hide_modal();
        ...
        copy_into_workflow: function copy_into_workflow(workflowId) {
            ...
            this._workflowLoadAjax(workflowId, {
                success: function success(data) {
                    ...
                    if (upgrade_message) {
                        window.show_modal("Subworkflow embedded with changes", "Problems were encountered loading this workflow (possibly a result of tool upgrades). Please review the following parameters and then save.<ul>" + upgrade_message + "</ul>", {
                            Continue: hide_modal
                        });
                    } else {
                        hide_modal();
        ...
        prebuildNode: function prebuildNode(type, title_text, content_id) {
            ...
            var node = new _workflowNode2.default(this, {
                element: $f
            });
            node.type = type;
