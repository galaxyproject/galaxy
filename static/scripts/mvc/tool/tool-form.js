define("mvc/tool/tool-form", ["exports", "utils/localization", "utils/utils", "mvc/ui/ui-misc", "mvc/ui/ui-modal", "mvc/tool/tool-form-base", "mvc/webhooks"], function(exports, _localization, _utils, _uiMisc, _uiModal, _toolFormBase, _webhooks) {
    "use strict";
    ...
    var View = Backbone.View.extend({
                        ...
                        error: function error(response, status) {
                            ...
                            if (status == 401) {
                                ...
                                Galaxy.modal && Galaxy.modal.show({
                                    title: (0, _localization2.default)("Tool request failed"),
                                    body: error_message,
                                    buttons: {
        ...
        _customize: function _customize(form) {
            ...
            var execute_button = new _uiMisc2.default.Button({
                ...
                title: (0, _localization2.default)("Execute"),
        ...
        submit: function submit(options, callback) {
            ...
            _utils2.default.request({
                ...
                error: function error(response) {
                    ...
                    if (!input_found) {
                        self.modal.show({
                            title: (0, _localization2.default)("Job submission failed"),
