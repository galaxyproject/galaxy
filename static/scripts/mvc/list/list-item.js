define("mvc/list/list-item", ["exports", "mvc/base-mvc", "utils/localization"], function(exports, _baseMvc, _localization) {
    "use strict";
    ...
    ListItemView.prototype.templates = function() {
        ...
        var titleBarTemplate = _baseMvc2.default.wrapTemplate([
            ...
            '<span class="state-icon"></span>', '<div class="title">', '<span class="name"><%- element.name %></span>', "</div>", '<div class="subtitle"></div>', "</div>"
        ], "element");
