    ...
    var HistoryView = _super.extend(
        /** @lends HistoryView.prototype */
        {
            ...
            loadHistory: function loadHistory(historyId, options, contentsOptions) {
                ...
                contentsOptions = _.extend(contentsOptions || {
                    silent: true
                });
                this.info("loadHistory:", historyId, options, contentsOptions);
                this.setModel(new _historyModel2.default.History({
                    id: historyId
                }));
            ...
            _firstSearch: function _firstSearch(searchFor) {
                ...
                var xhr = this.model.contents.progressivelyFetchDetails({
                    silent: true
            ...
            clearSearch: function clearSearch(searchFor) {
                ...
                this.model.contents.fetchCurrentPage({
                    silent: true
                }).done(function() {
                    _this4.renderItems();
                });
            ...
            scrollToHid: function scrollToHid(hid) {
                return this.scrollToItem(_.first(this.viewsWhereModel({
                    hid: hid
                })));
            },
