define("mvc/history/job-dag", ["exports", "utils/graph", "utils/add-logging"], function(exports, _graph, _addLogging) {
    "use strict";
    ...
    // ============================================================================
    var _super = _graph2.default.Graph;
     ...
     */
    var JobDAG = function JobDAG(options) {
        options = options || {};
        var self = this;
        //this.logger = console;
    ...
    JobDAG.prototype.read = function _read(data) {
        ...
        if (_.has(data, "historyContents") && _.has(data, "jobs") && _.has(data, "tools")) {
            ...
            self.preprocessHistoryContents(data.historyContents || []).preprocessTools(data.tools || {}).preprocessJobs(data.jobs || []);
