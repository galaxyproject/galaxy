define("mvc/history/multi-panel", ["exports", "utils/localization", "mvc/history/history-model", "mvc/history/history-view-edit", "mvc/history/job-states-model", "mvc/history/copy-dialog", "mvc/ui/error-modal", "mvc/base-mvc", "utils/ajax-queue", "ui/mode-button", "ui/search-input"], function(exports, _localization, _historyModel, _historyViewEdit, _jobStatesModel, _copyDialog, _errorModal, _baseMvc, _ajaxQueue) {
    "use strict";
    ...
    var MultiPanelColumns = Backbone.View.extend(_baseMvc2.default.LoggableMixin).extend({
        ...
        renderColumns: function renderColumns(speed) {
            ...
            if (self.datasetSearch && sortedAndFiltered.length <= 1) {} else {
        ...
        setUpBehaviors: function setUpBehaviors() {
            ...
            multipanel.$("#search-histories").searchInput({
                ...
                onfirstsearch: function onfirstsearch(searchFor) {
                    ...
                    multipanel.renderInfo((0, _localization2.default)("loading all histories for search"));
            ...
            multipanel.$("#search-datasets").searchInput({
                ...
                onfirstsearch: function onfirstsearch(searchFor) {
                    ...
                    multipanel.hdaQueue.progress(function(progress) {
                        multipanel.renderInfo([(0, _localization2.default)("searching"), progress.curr + 1, (0, _localization2.default)("of"), progress.total].join(" "));
                    });
