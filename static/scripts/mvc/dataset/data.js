define("mvc/dataset/data", ["exports", "utils/localization", "mvc/ui/ui-modal", "mvc/ui/ui-frames", "mvc/ui/icon-button"], function(exports, _localization, _uiModal, _uiFrames, _iconButton) {
    "use strict";
        ...
        initialize: function initialize(options) {
            ...
            var btn_viz = new _iconButton2.default.IconButtonView({
                model: new _iconButton2.default.IconButton({
                    title: (0, _localization2.default)("Visualize"),
        ...
        show: function show(e) {
            ...
            if (!chrom.match("^#") && chrom !== "" && is_numeric(start)) {
                ...
                $("#btn_viz").click(function() {
                    self.frame.add({
                        title: (0, _localization2.default)("Trackster"),
