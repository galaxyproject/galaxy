...
var LibraryView = Backbone.View.extend({
  ...
  showPermissions: function(options){
    ...
    this.$el.html(template({library: this.model}));
  ...
  prepareSelectBoxes: function(options){
    ...
    self.accessSelectObject = new mod_select.View(this._createSelectOptions(this, 'access_perm', selected_access_library_roles));
    self.addSelectObject = new mod_select.View(this._createSelectOptions(this, 'add_perm', selected_add_item_roles));
    self.manageSelectObject = new mod_select.View(this._createSelectOptions(this, 'manage_perm', selected_manage_library_roles));
    self.modifySelectObject = new mod_select.View(this._createSelectOptions(this, 'modify_perm', selected_modify_library_roles));
  },
  ...
  _createSelectOptions: function(self, id, init_data){
    var select_options = {
      ...
      ajax: {
          url: "/api/libraries/" + self.id + "/permissions?scope=available",
          dataType: 'json',
          quietMillis: 100,
  ...
  templateLibraryPermissions : function(){
    ...
    tmpl_array.push('<h1>Permissions: <%= _.escape(library.get("name")) %></h1>');
