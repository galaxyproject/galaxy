define([ "mvc/toolshed/toolshed-model", "mvc/toolshed/util" ], function(toolshed_model, toolshed_util) {
    var View = Backbone.View.extend({
        ...
        initialize: function() {
            this.options = _.defaults(this.options || {}, this.defaults), this.model = new toolshed_model.ShedsCollection(), 
            this.listenTo(this.model, "sync", this.render), this.model.fetch();
        },
        el: "#center",
        render: function(options) {
            ...
            this.$el.html(toolshed_list_template({
                title: "Accessible Galaxy ToolSheds",
