define([ "mvc/toolshed/toolshed-model" ], function(toolshed_model) {
    var ToolShedCategories = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.listenTo(this.model, "sync", this.render), console.log(this.options), this.model.url = this.model.url + "?tool_shed_url=" + this.options.tool_shed, 
            console.log(this.model.url), this.model.fetch();
        },
        render: function(options) {
            console.log(this.model), this.options = _.extend(this.options, options), console.log(this.options), 
