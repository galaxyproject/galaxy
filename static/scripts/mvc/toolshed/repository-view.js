    ...
    var ToolShedRepositoryView = Backbone.View.extend({
        ...
        bindEvents: function() {
            ...
            $("#changeset").on("change", function() {
                ...
                console.log(tps), params.tool_panel_section = JSON.stringify(that.panelSelect(params)), 
