define("mvc/toolshed/repository-view", ["exports", "mvc/toolshed/toolshed-model", "libs/jquery/jstree", "utils/utils", "mvc/ui/ui-modal", "mvc/form/form-view", "mvc/toolshed/util"], function(exports, _toolshedModel, _jstree, _utils, _uiModal, _formView, _util) {
    "use strict";
        ...
        bindEvents: function bindEvents() {
            ...
            $("#install_repository").on("click", function(ev) {
                ...
                params.repositories = JSON.stringify([
                    [$("#install_repository").attr("data-tsrid"), $("#changeset").find("option:selected").val()]
                ]);
