            ...
            require([ "libs/jquery/jquery-ui" ], function() {
                $("#search_box").autocomplete({
                    ...
                    select: function(event, ui) {
                        var tsr_id = ui.item.value, new_route = "repository/s/" + that.model.tool_shed + "/r/" + tsr_id;
