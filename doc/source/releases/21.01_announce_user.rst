...
But the addition of the Remote Files browser didn't stop there! Serveral other interfaces received updates to use this new framework:
...
This is a new section covering smaller improvements that just make your life esaier.
