...
If you're building advanced workflows utilizing Galaxy's powerful sub-workflows for re-usable workflow components, then you'll be pleased to know you can now automatically update those to the latest version
