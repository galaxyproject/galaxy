...
To stay up to date with Galaxy's progress you can watch `screencasts <https://vimeo.com/galaxyproject>`__, 
read our `wiki <https://wiki.galaxyproject.org/>`__, and follow `@galaxyproject <https://twitter.com/galaxyproject>`__
