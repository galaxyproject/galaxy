...
**Support for compressed FASTQ formats**
  ...
  Thanks to `@abretaud <https://github.com/abretaud>`__, `@jmchilton <https://github.com/jmchilton>`__, `@jvolkening <https://github.com/jvolkening>`__, and `@mvdbeek <https://github.com/mvdbeek>`__.
