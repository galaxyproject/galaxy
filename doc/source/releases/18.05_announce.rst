...
**New Interface Style Library**
  ...
  of upgrading to Bootstrap 4 style library. The upgrade process was a large community effort
...
**New Powerful Rule-Based Data Uploader**
  The Galaxy features a powerful new interface for manipulating lists of rules for processing metadata
...
**GDPR Compliance Mode**
 We introduce basic GDPR compliance mode. Admins can enable it to help them comply with the European Union law known as `General Data Protection Regulation <http://eur-lex.europa.eu/legal-content/en/TXT/?uri=CELEX:32016R0679>`__ which goes into effect on May 25, 2018. Thanks to `@erasche <https://github.com/erasche>`__.
...
**Viz Frameworks Unified**
  The charts and generic visualization frameworks have been merged together into a single coherent
  one. You can use a new menu option to list and search all available visualizations together.
