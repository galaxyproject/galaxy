...
And then you will be able to see your load your files easily in Galaxy!
...
Upload Directly from the Tool From
----------------------------------
...
So we have replaced the layout algorithm with a newer one which should make the flow of data within your workflows easier to understand. You will still probably want to make manualy adjustments after the automatic layout, but hopefully this will save you some time.
...
When one or more workflows is submitted, the status page reporting on those workflow(s) and their reports has been improved!
