...
**Deferred dataset resolution**
  ...
  Instead these datasets are only fetched when jobs using these datasets are run.
...
-  mapping.galaxy.mapping.amqp_internal_connection.desc has changed from
...
-  mapping.galaxy.mapping.heartbeat_interval.desc has changed from
...
-  mapping.galaxy.mapping.log_level.desc has changed from
...
-  mapping.galaxy.mapping.monitor_thread_join_timeout.desc has changed from
