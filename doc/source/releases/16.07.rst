...
* TS API: add endpoint to check current user
  `Pull Request 2243`_
...
* Collection Operations (Limited)
  `Pull Request 2434`_
* Implement UI to display list of lists dataset collections
  `Pull Request 2613`_
...
* Generate metadata in separate conda environment
  (thanks to `@mvdbeek <https://github.com/mvdbeek>`__.)
  `Pull Request 2253`_
* Reports: new pages and improvements
...
* Allow tool form to listen to history
  ...
  `Pull Request 2476`_
* Add EDAM operations to tools and expose in API
  (thanks to `@mvdbeek <https://github.com/mvdbeek>`__.)
  `Pull Request 2379`_
...
* API: add server_starttime to api/configuration
  `Pull Request 2124`_
* This should fix bug `#1892
  <https://github.com/galaxyproject/galaxy/issues/1892>`__ in toolshed
  (thanks to `@nturaga <https://github.com/nturaga>`__.)
  `Pull Request 2142`_
...
* Tool execution dependency resolution already contains the relevant
  `Pull Request 2254`_
* add Saskia to contributors
  `Pull Request 2256`_
* A pass adding new contributors from 15.10->16.04(ish).
  `Pull Request 2257`_
* Sort contributors by surname ASC.
  `Pull Request 2258`_
...
* More small fixes from downstream projects.
  `Pull Request 2292`_
* For published workflow display, Provide a better error when the workf…
  `Pull Request 2302`_
...
* Add a new workflow building mode variation which does access the history
  `Pull Request 2390`_
* Fixes pep8 issues from `#2386
  <https://github.com/galaxyproject/galaxy/issues/2386>`__
  (thanks to `@galaxyproject <https://github.com/galaxyproject>`__.)
  `Pull Request 2392`_
...
* Kubernetes runner: improves handling of failed jobs
  ...
  `Pull Request 2559`_
* Fixes `#2442 <https://github.com/galaxyproject/galaxy/issues/2442>`__
  (thanks to `@erasche <https://github.com/erasche>`__.)
  `Pull Request 2572`_
* Python3: port 215 files
  (thanks to `@bxlab <https://github.com/bxlab>`__.)
  `Pull Request 2574`_
...
* Build job success messages within tool form view
  `Pull Request 2355`_
* Cleanup of E203 primarily, and some other misc formatting encountered…
  `Pull Request 2364`_
...
* Do not encode dict items that start with 'metadata_' in return value of
  api/tools/create.
  `Pull Request 2459`_
...
* Add pyparsing dependency of svgwrite. Unpin mercurial.
  (thanks to `@nsoranzo <https://github.com/nsoranzo>`__.)
  `Pull Request 2223`_
* Fixes `#2230 <https://github.com/galaxyproject/galaxy/issues/2230>`__
  (thanks to `@erasche <https://github.com/erasche>`__.)
  `Pull Request 2231`_
...
* Cast everything to a string
  (thanks to `@erasche <https://github.com/erasche>`__.)
  `Pull Request 2252`_
* Use standard model.orm.now for toolshed's password reset token dateti…
  `Pull Request 2261`_
...
* update check for Conda env.
  (thanks to `@matthdsm <https://github.com/matthdsm>`__.)
  `Pull Request 2295`_
* Make grunt watch (for scripts) work again, settings were being overwr…
  `Pull Request 2296`_
...
* Unicodify has different semantics to str, causing bug reporter bug
  (thanks to `@erasche <https://github.com/erasche>`__.)
  `Pull Request 2336`_
* Wrap statsd timing middleware more closely around the core applicatio…
  `Pull Request 2342`_
...
* Toolbox filter fixes
  `Pull Request 2499`_
* This is an extra hammer swing at `#1531
  <https://github.com/galaxyproject/galaxy/issues/1531>`__ / `#1542
  <https://github.com/galaxyproject/galaxy/issues/1542>`__
  `Pull Request 2505`_
...
* Ensure Galaxy's python binary is used for metadata generation.
  `Pull Request 2660`_
* Fix an error with getting the size of an object from Azure.  Attempte…
  `Pull Request 2678`_
* Limit creation of multitudes of default, empty histories.
  `Pull Request 2684`_
* Fix the sanitization of None values in utils.  This had previously no…
  `Pull Request 2693`_
* Fix: Remove the old HubAssembly class
  (thanks to `@remimarenco <https://github.com/remimarenco>`__.)
  `Pull Request 2701`_
