...
**Reports Application Enhancements**
  This release features a wide variety of improvements and fixes to the reports app thanks to Daniel Bouchard - including a new landing page, improved sorting,
  pagination, and sparkline graphs.
