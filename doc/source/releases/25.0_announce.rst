...
**Dataset View Component**. Galaxy 25.0 introduces a centralized view for datasets, consolidating common
dataset actions into a single, streamlined interface, all accessible via the eye icon on datasets.
