...
.. raw:: html
   ...
   <video controls autoplay loop muted width="100%" alt="Gif of the colour selector in action, a mouse clicks on the colour selector and gone is the restricted 20 colour pallete, now there is a colour field and you can select any possible RGB colour.">
       <source src="images/22.01-colour.mp4" type="video/mp4">
   </video>
...
.. raw:: html
   ...
   <video controls autoplay loop muted width="100%" alt="Video of a user exporting a file using the new file export, selecting a folder, creating some subdirectories, before changing their mind and choosing another location to export their file to.">
       <source src="images/22.01-export.mp4" type="video/mp4">
   </video>
