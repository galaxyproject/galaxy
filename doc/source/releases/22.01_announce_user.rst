...
If you've been trying out the beta history (which will be the default history next release!), it has been updated to indicate whether collections are homogeneous or heterogeneous, which will help you see more easily if you've accidentally included an incorrect dataset. Test out the beta history today and let us know if you have any issues!
