...
**User Preferences can be encrypted in Galaxy Vault**
  @nuwang, could you write something about this please?
...
**Resumable uploads via tus.io, improved upload provenance**
  ...
  solutions. For detailed documentation see the `documentation <https://docs.galaxyproject.org/en/release_22.01/admin/nginx.html#receiving-files-via-the-tus-protocol>`__.
  Galaxy now displays all manipulations that were peformed during an upload,
