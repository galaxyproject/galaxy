...
* add new tabular file formats cns,cnr and cnn to datatypes_conf.xml.sample file as they are neaded for cnvkit galaxy tools
...
* Update carbon emissions methodology page to match current feature spe…
  (thanks to `@Renni771 <https://github.com/Renni771>`__).
...
* WF Report Enhancement: Adding Time Format to Time the Workflow Report was Generated
  (thanks to `@assuntad23 <https://github.com/assuntad23>`__).
...
* Toolshed client build separation
  (thanks to `@dannon <https://github.com/dannon>`__).
...
* prep for updated h5py and typos
  (thanks to `@mr-c <https://github.com/mr-c>`__).
...
* Ensure that plugin build hash actually has a git hash to compare with…
  (thanks to `@dannon <https://github.com/dannon>`__).
