...
**Shift of Galaxy tool dependencies to Conda**
  ...
  A document by IUC that explains all things Conda is `available <https://docs.google.com/document/d/1kM09cQmhF14WVBs_Uprmt93aB8kdiBVRkGUmjqfJpso/pub>`__.
...
**Dynamic tool destinations**
  ...
  `documentation <https://wiki.galaxyproject.org/Admin/Config/Jobs#Dynamic_Destination_Mapping>`__.
