...
**Revised UI Style**
  ...
  `Pull Request 6422`_, `Pull Request 6910`_, `Pull Request 6881`_,
  `Pull Request 6967`_, `Pull Request 6790`_, `Pull Request 6868`_,
  `Pull Request 7017`_, `Pull Request 6985`_, `Pull Request 6870`_,
  `Pull Request 6905`_

**More Colorful Tags**
  Use consistently hashed randomized colors for history dataset name tags to allow increase visual
...
**Extensive Workflow Enhancements (continued)**
  18.09 featured a bunch of important and diverse fixes and enhancements to workflows on
  both the frontend and backend. That progress continues in 19.01.
  ...
  and allows import and export of human readable workflows (`Pull Request 6776`_, `Pull Request 6811`_,
  `Pull Request 6807`_, `Pull Request 6746`_) as well as extensions to allow Galaxy
...
**Support for Singularity Biocontainers**
  Galaxy can now be configured to fetch `Biocontainers <https://biocontainers.pro/>`__ automatically
  for `Singularity <https://singularity.lbl.gov/>`__ enabled job destinations. Previously this
  would happen automatically for Docker containers but not Singularity containers. Thanks to
