...
**Client Architecture**
  ...
  `Pull Request 4435`_, `Pull Request 4978`_, `Pull Request 4436`_,
...
**Dataset Collection Usability**
  ...
  to collections have been made, some the key highlights include:
    ...
    - Implement intuitive workflow post job actions for dataset collections. `Pull Request 5416`_, `Pull Request 5418`_
