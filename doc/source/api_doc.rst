...
The up-to-date Galaxy API documentation can be accessed by appending ``api/docs``
...
developed by the Galaxy community including `Python
<https://bioblend.readthedocs.io/>`__, `PHP
<https://github.com/galaxyproject/blend4php>`__, `Java
<https://github.com/jmchilton/blend4j>`__, and `JavaScript
<https://github.com/galaxyproject/galaxy/tree/dev/client/src/mvc>`__.
