<%def name="render_external_service( external_service, show_all='True' )">
    <div class="form-row">
        <label>Name:</label>
        %if show_all == 'True':
    ...
    %if show_all == 'True':
	    ...
	    <div class="form-row">
	        ...
	        ${external_service.create_time}
	        <div style="clear: both"></div>
	    </div>
	    <div class="form-row">
	        <label>Update date:</label>
	        ${external_service.update_time}
	        <div style="clear: both"></div>
	    </div>
    %endif
    <div class="form-row">
        ...
        %else:
            ${'Error in loading external_service type: %s' % external_service.external_service_type_id}
        %endif
        <div style="clear: both"></div>
    </div>
