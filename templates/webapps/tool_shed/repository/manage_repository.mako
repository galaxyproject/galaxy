    ...
    <div class="toolFormBody">
        <form name="edit_repository" id="edit_repository" action="${h.url_for( controller='repository', action='manage_repository', id=trans.security.encode_id( repository.id ) )}" method="post" >
            ...
            <div class="form-row">
                ...
                <button title="to clipboard" class="btn btn-secondary btn-xs" id="share_clipboard"><span class="fa fa-clipboard"></span></button>
            </div>
            %if can_download or can_push:
                <div class="form-row">
                    ...
                    <button title="to clipboard" class="btn btn-secondary btn-xs" id="clone_clipboard"><span class="fa fa-clipboard"></span></button>
                </div>
            %endif
