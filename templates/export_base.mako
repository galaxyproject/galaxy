...
<%def name="render_url_for_importing(item)">
    ...
    %if item.importable:
        ...
        <div class="display-url">
            ${h.url_for(controller=self.controller, action='display_by_username_and_slug', username=trans.user.username,
...
<%def name="render_download_to_file(item)">
    ...
    <a href="${h.url_for( controller=self.controller, action='display_by_username_and_slug', username=trans.user.username,
