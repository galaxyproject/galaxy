...
${render_permission_form( data_list[0], name_str, h.url_for( controller='library', action='library_dataset_dataset_association', id=ldda_ids, library_id=library_id, permissions=True ), roles )}
