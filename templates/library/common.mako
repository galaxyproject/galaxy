	...
	<div style="overflow: hidden;" class="historyItemTitleBar">
        ...
        <%doc>
	       <div style="float: right;">
	           ...
	           <a href="${h.url_for( controller='root', action='delete', id=data.id )}" class="historyItemDelete" id="historyItemDelter-${data.id}"><img src="${h.url_for('/static/images/delete_icon.png')}" rollover="${h.url_for('/static/images/delete_icon_dark.png')}" width='16' height='16' alt='delete' class='deleteButton' border='0'></a>
	       </div>
        </%doc>
