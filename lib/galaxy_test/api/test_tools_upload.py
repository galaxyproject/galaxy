...
class ToolsUploadTestCase(ApiTestCase):
    ...
    def test_upload_of_randomly_generated_file(self):
        ...
        min_file_size_in_mb = 10
        max_file_size_in_mb = 30
        min_delay_between_steps = 1
        max_delay_between_steps = 3
        ...
        # File size
        file_size = random.randint(min_file_size_in_mb, max_file_size_in_mb) * 1024 * 1024
        ...
        # Random sleep
        time.sleep(random.randint(min_delay_between_steps, max_delay_between_steps))
        ...
        # Extract history ID and content ID
