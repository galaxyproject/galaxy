"""Tests for the upload activity panel's direct collection creation flow.

These tests verify that the upload activity UI creates dataset collections
...
class TestUploadActivityCollection(SeleniumTestCase, UsesHistoryItemAssertions):
    ...
    def _navigate_to_upload_method(self, method_id):
        ...
        Opens the activity settings panel, clicks the Upload activity
        ...
        # Click the Upload activity in settings to open its sidebar panel
    ...
    def _enable_collection_creation(self, name, collection_type="list"):
        ...
        name_input = self.components.upload_activity.collection_name_input.wait_for_visible()
        name_input.clear()
    ...
    @selenium_test
    def test_upload_activity_paste_links_as_list_collection(self):
    ...
    @selenium_test
    def test_upload_activity_paste_links_as_paired_collection(self):
