...
class ManageInformationTestCase(SeleniumTestCase):
    ...
    def test_api_key(self):
        ...
        new_key_button = self.driver.find_element(By.ID, "submit")
        api_key_input = self.driver.find_element(By.CSS_SELECTOR, "[data-label='Current API key:'] > input")
    ...
    def test_change_email(self):
        def assert_email(email_to_check):
            self.assertTrue(email_to_check == self.driver.find_element(By.ID, "user-preferences-current-email").text)
        ...
        email_input_field = self.driver.find_element(By.CSS_SELECTOR, "input[id='email']")
    ...
    def test_public_name(self):
        def get_name_input_field():
            return self.driver.find_element(By.CSS_SELECTOR, "input[id='username']")
    ...
    def test_user_address(self):
        def get_address_form():
            return self.driver.find_element(By.CSS_SELECTOR, "div.ui-portlet-section > div.portlet-content")
    ...
    def get_address_input_field(self, address_form, input_field_label):
        return address_form.find_element(By.CSS_SELECTOR, f"[data-label='{input_field_label}'] > input")
