...
class CollectionEditTestCase(SeleniumTestCase):
    ...
    def change_dbkey_value_and_click_submit(self, dbkeyValue, dbkeyNew):
        ...
        self.driver.find_element(By.CSS_SELECTOR, "input.multiselect__input").send_keys(dbkeyNew)
        self.driver.find_element(By.CSS_SELECTOR, "input.multiselect__input").send_keys(Keys.ENTER)
