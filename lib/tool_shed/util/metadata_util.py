...
def get_latest_changeset_revision( app, repository, repo ):
    ...
    changeset_revisions = suc.get_metadata_revisions( repository, repo, include_hash=False, downloadable=False )
...
def get_previous_metadata_changeset_revision( repository, repo, before_changeset_revision, downloadable=True ):
    ...
    """
    changeset_revisions = suc.get_metadata_revisions( repository, repo, include_hash=False, downloadable=downloadable )
