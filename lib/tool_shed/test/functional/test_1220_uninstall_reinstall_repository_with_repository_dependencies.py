...
class UninstallingAndReinstallingRepositories(ShedTwillTestCase):
    ...
    def test_0005_ensure_repositories_and_categories_exist(self):
        ...
        category = self.create_category(
            name="Test 0020 Basic Repository Dependencies", description="Tests for a repository with tool dependencies."
        )
        self.login(email=common.test_user_1_email, username=common.test_user_1_name)
    ...
    def test_0025_deactivate_emboss_repository(self):
        ...
        strings_not_displayed = ["emboss_0020", installed_repository.installed_changeset_revision]
        self.display_galaxy_browse_repositories_page(strings_not_displayed=strings_not_displayed)
