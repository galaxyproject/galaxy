...
class GalaxyUtilityContainerManager(
    ...
    def build_repository_containers(self,
        ...
        try:
            ...
            if missing_repository_dependencies:
                folder_id, missing_repository_dependencies_root_folder = \
                    self.build_repository_dependencies_folder(folder_id=folder_id,
                                                              ...
                                                              installed=False)
                containers_dict[
                    'missing_repository_dependencies'] = missing_repository_dependencies_root_folder
            ...
            if missing_tool_dependencies:
                ...
                folder_id, missing_tool_dependencies_root_folder = \
                    self.build_tool_dependencies_folder(folder_id,
                                                        ...
                                                        reinstalling=reinstalling)
                containers_dict[
                    'missing_tool_dependencies'] = missing_tool_dependencies_root_folder
            ...
            if valid_data_managers:
                ...
                containers_dict[
                    'valid_data_managers'] = valid_data_managers_root_folder
            if invalid_data_managers or data_managers_errors:
                ...
                containers_dict[
                    'invalid_data_managers'] = invalid_data_managers_root_folder
