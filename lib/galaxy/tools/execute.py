...
def execute(trans, tool, mapping_params, history, rerun_remap_job_id=None, collection_info=None, workflow_invocation_uuid=None, invocation_step=None, max_num_jobs=None, job_callback=None, workflow_resource_parameters=None):
    """
    ...
    def execute_single_job(execution_slice):
        ...
        job, result = tool.handle_single_execution(trans, rerun_remap_job_id, params, execution_slice, history, execution_cache)
        if job:
