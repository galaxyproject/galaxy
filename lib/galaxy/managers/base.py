...
class HasAModelManager:
    ...
    def __init__(self, app: MininmalManagerApp, manager=None, **kwargs):
...
class ModelSerializer(HasAModelManager):
    ...
    def __init__(self, app: MininmalManagerApp, **kwargs):
        """
...
class ModelDeserializer(HasAModelManager):
    ...
    def __init__(self, app: MininmalManagerApp, validator=None, **kwargs):
        """
