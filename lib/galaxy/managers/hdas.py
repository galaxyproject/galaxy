...
class HDAManager(datasets.DatasetAssociationManager,
    ...
    # TODO: which of these are common with LDDAs and can be pushed down into
    ...
    def is_owner(self, hda, user, current_history=None, **kwargs):
        ...
        # TODO: awkward kwarg (which is my new band name); this may not belong
        # here - move to controller?
    ...
    def create(self, history=None, dataset=None, flush=True, **kwargs):
        ...
        # TODO:?? some internal sanity check here (or maybe in add_dataset) to
        # make sure hids are not duped?
    ...
    def copy(self, hda, history=None, **kwargs):
        ...
        # In some instances peek relies on dataset_id, i.e. gmaj.zip for
        # viewing MAFs
...
class HDASerializer(
    ...
    def __init__(self, app):
        ...
        # keyset returned to create show a dataset where the owner has no
        # access
    ...
    def add_serializers(self):
        ...
        self.serializers.update({
            ...
            # see also:
            # https://sentry.galaxyproject.org/galaxy/galaxy-main/group/20769/events/9352883/
