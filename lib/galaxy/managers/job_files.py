...
class JobFilesManager:
    ...
    def authorize_for_files(self, encoded_job_id: str, supplied_job_key: str | None) -> Job:
    ...
    def authorize_for_token(self, encoded_job_id: str, supplied_job_key: str | None) -> Job:
    ...
    def _compute_resource_writable_working_dir_path(self, job: Job, path: str) -> bool:
        ...
        """
        job_dir = os.path.realpath(JobWorkingDirectory(job, self._app.object_store).resolve())
