...
def to_basic_markdown(trans, internal_galaxy_markdown: str) -> str:
    ...
    # we want the second form here with the embedded tags expanded, for PDF export we don't care about
    # preserving the source in anyway
    _, plain_markdown = directive_handler.walk(trans, internal_galaxy_markdown)
