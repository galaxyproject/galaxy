...
# totally new area, but I'm leaving it in managers for now for class
# consistency.
...
# TODO: for lack of a manager file for the config. May well be better in
# config.py? Circ imports?
