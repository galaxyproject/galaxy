...
class DatasetManager(base.ModelManager, secured.AccessibleManagerMixin, deletable.PurgableManagerMixin):
    ...
    # TODO:?? get + error_if_uploading is common pattern, should upload check
    # be worked into access/owed?
...
class DatasetAssociationManager(base.ModelManager,
    ...
    # Instead, a dataset association HAS a dataset but contains metadata
    # specific to a library (lda) or user (hda)
    ...
    def purge(self, dataset_assoc, flush=True):
        ...
        super(DatasetAssociationManager, self).purge(
            dataset_assoc, flush=flush)
    ...
    def creating_job(self, dataset_assoc):
        ...
        # TODO: this would be even better if outputs and inputs were the
        # underlying datasets
        job = None
...
class _UnflattenedMetadataDatasetAssociationSerializer(base.ModelSerializer,
    ...
    def add_serializers(self):
        ...
        self.serializers.update({
            ...
            # TODO: why is this named uuid!? The da doesn't have a uuid - it's
            # the underlying dataset's uuid!
        ...
        # because of that: we need to add a few keys that will use the default
        # serializer
...
class DatasetAssociationSerializer(_UnflattenedMetadataDatasetAssociationSerializer):
    # TODO: remove this class - metadata should be a sub-object instead as in
    # the superclass
