...
class HTTPFilesSource(BaseFilesSource):
    ...
    def __init__(self, label="HTTP File", doc="Default HTTP file handler", **kwd):
        ...
        kwds.update(kwd)
        props: HTTPFilesSourceProperties = cast(HTTPFilesSourceProperties, self._parse_common_config_opts(kwd))
    ...
    def _realize_to(self, source_path: str, native_path: str, user_context=None, **kwargs: Unpack[FilesSourceOptions]):
        ...
        extra_props: HTTPFilesSourceProperties = cast(HTTPFilesSourceProperties, kwargs.get("extra_props") or {})
