...
class RepoWeighting(scoring.BM25F):
    ...
    def final(self, searcher, docnum, score):
        ...
        stored_times_downloaded = searcher.stored_fields(docnum)[
            "times_downloaded"]
        ...
        cert_modifier = 2 if searcher.stored_fields(docnum)[
            "approved"] == 'yes' else 1
    ...
    def search(self, trans, search_term, page, page_size, boosts):
        ...
        if index_exists:
            ...
            try:
                ...
                repo_weighting = RepoWeighting(field_B={
                    'name_B':
                    boosts.repo_name_boost,
                    'description_B':
                    boosts.repo_description_boost,
                    'long_description_B':
                    boosts.repo_long_description_boost,
                    'homepage_url_B':
                    boosts.repo_homepage_url_boost,
