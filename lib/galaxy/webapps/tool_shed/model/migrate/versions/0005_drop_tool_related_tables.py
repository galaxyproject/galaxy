...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.debug(
            "Dropping tool_category_association table failed: %s" % str(e))
    ...
    try:
        ...
        log.debug(
            "Dropping tool_annotation_association table failed: %s" % str(e))
...
def downgrade(migrate_engine):
    ...
    Tool_table = Table(
        ...
        Column(
            "newer_version_id", Integer, ForeignKey("tool.id"), nullable=True),
    ...
    ToolCategoryAssociation_table = Table(
        "tool_category_association", metadata,
        Column("id", Integer, primary_key=True),
    ...
    ToolAnnotationAssociation_table = Table(
        "tool_annotation_association", metadata,
        Column("id", Integer, primary_key=True),
        Column("tool_id", Integer, ForeignKey("tool.id"), index=True),
        Column("user_id", Integer, ForeignKey("galaxy_user.id"), index=True),
    ...
    try:
        ...
        log.debug(
            "Creating tool_category_association table failed: %s" % str(e))
    ...
    try:
        ...
        log.debug(
            "Creating tool_annotation_association table failed: %s" % str(e))
