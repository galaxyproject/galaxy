...
def upgrade(migrate_engine):
    ...
    try:
        c.create(
            ...
            index_name="ix_repository_metadata_inc_datatypes")
        assert c is RepositoryMetadata_table.c.includes_datatypes
        migrate_engine.execute(
            "UPDATE repository_metadata SET includes_datatypes=%s" %
            default_false)
    except Exception as e:
        print "Adding includes_datatypes column to the repository_metadata table failed: %s" % str(
            e)

    # Create includes_datatypes column
    c = Column(
        "has_repository_dependencies", Boolean, default=False, index=True)
    try:
        c.create(
            RepositoryMetadata_table,
            index_name="ix_repository_metadata_has_repo_deps")
        ...
        print "Adding has_repository_dependencies column to the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        c.create(
            RepositoryMetadata_table,
            index_name="ix_repository_metadata_inc_tools")
        assert c is RepositoryMetadata_table.c.includes_tools
        migrate_engine.execute(
            "UPDATE repository_metadata SET includes_tools=%s" % default_false)
    except Exception as e:
        print "Adding includes_tools column to the repository_metadata table failed: %s" % str(
            e)

    # Create includes_tool_dependencies column
    c = Column(
        "includes_tool_dependencies", Boolean, default=False, index=True)
    try:
        c.create(
            RepositoryMetadata_table,
            index_name="ix_repository_metadata_inc_tool_deps")
        ...
        print "Adding includes_tool_dependencies column to the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        c.create(
            RepositoryMetadata_table,
            index_name="ix_repository_metadata_inc_workflows")
        assert c is RepositoryMetadata_table.c.includes_workflows
        migrate_engine.execute(
            "UPDATE repository_metadata SET includes_workflows=%s" %
            default_false)
    except Exception as e:
        print "Adding includes_workflows column to the repository_metadata table failed: %s" % str(
            e)
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        print "Dropping column includes_workflows from the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        ...
        print "Dropping column includes_tool_dependencies from the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        ...
        print "Dropping column includes_tools from the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        ...
        print "Dropping column has_repository_dependencies from the repository_metadata table failed: %s" % str(
            e)
    ...
    try:
        ...
        print "Dropping column includes_datatypes from the repository_metadata table failed: %s" % str(
            e)
