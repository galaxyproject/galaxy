...
class Configuration(object):
    def __init__(self, **kwargs):
        ...
        # Tool stuff
        self.tool_path = resolve_path(
            kwargs.get("tool_path", "tools"), self.root)
    ...
    def __parse_config_file_options(self, kwargs):
        defaults = dict(
            auth_config_file=[
                'config/auth_conf.xml', 'config/auth_conf.xml.sample'
            ],
            datatypes_config_file=[
                'config/datatypes_conf.xml', 'datatypes_conf.xml',
    ...
    def check(self):
        ...
        paths_to_check = [
            self.root, self.file_path, self.hgweb_config_dir,
            self.tool_data_path, self.template_path
        ]
