...
<%def name="main_body()">
  <div class="reportBody">
    <h3 align="center">Jobs for tool "${tool_id}" during ${month_label}&nbsp;${year_label}</h3>
    %if msg:
    ...
    <table align="center" width="60%" class="colored">
      %if len( jobs ) == 0:
        <tr><td colspan="5">There are no jobs for ${tool_id} during ${month_label}&nbsp;${year_label}</td></tr>
      %else:
        %for job in jobs:
          <% 
            state = job[0]
