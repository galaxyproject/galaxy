...
def populate_api_routes( webapp, app ):
    ...
    webapp.mapper.connect( '/api/workflows/get_workflow_menu', action='workflow_menu', controller="workflows" )
    webapp.mapper.connect( '/api/workflows/set_workflow_menu', action='workflow_menu', controller="workflows" )
