...
def populate_api_routes( webapp, app ):
    ...
    webapp.mapper.connect( '/api/workflows/get_workflow_menu', action='get_workflow_menu', controller="workflows" )
    webapp.mapper.connect( '/api/workflows/workflow_menu', action='workflow_menu', controller="workflows" )
