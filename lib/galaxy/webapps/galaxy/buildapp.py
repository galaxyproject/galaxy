...
def app_factory(global_conf, load_app_kwds={}, **kwargs):
    ...
    webapp.add_client_route('/admin/data_manager', 'admin')
    webapp.add_client_route('/admin/data_manager/manage_data_manager', 'admin')
    webapp.add_client_route('/admin/data_manager/view_job', 'admin')
