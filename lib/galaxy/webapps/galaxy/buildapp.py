...
def populate_api_routes(webapp, app):
    ...
    webapp.mapper.connect('job_information', '/api/jobs/{job_id}/job_information', controller='jobs', action='job_information', conditions=dict(method=['GET']))
    ...
    webapp.mapper.connect('decode_id',
                          '/api/security/decode/{id}',
                          controller='security',
                          action='decode_id', conditions=dict(method=['GET']))
