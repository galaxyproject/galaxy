...
class FastAPIGroupRoles:
    manager: GroupRolesManager = depends(NotificationManager)
    ...
    def update(self, notification, updated_message):
        return self.manager.update(notification, updated_message)
