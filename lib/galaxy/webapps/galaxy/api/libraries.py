...
class LibrariesController(BaseAPIController):
    ...
    def index(self, trans, **kwd):
        ...
        * GET /api/libraries:
        ...
        for library in query:
            libraries.append(
                self.library_manager.get_library_dict(trans, library))
        return libraries
    ...
    def show(self, trans, id, deleted='False', **kwd):
        ...
        * GET /api/libraries/deleted/{encoded_id}:
        ...
        """
        library = self.library_manager.get(trans,
                                           self.__decode_id(
                                               trans, id, 'library'))
    ...
    def update(self, trans, id, payload=None, **kwd):
       ...
       .. note:: Currently, only admin users can update libraries. Also the library must not be `deleted`.
        ...
        updated_library = self.library_manager.update(trans, library, name,
                                                      description, synopsis)
        library_dict = self.library_manager.get_library_dict(
            trans, updated_library)
        return library_dict
    ...
    def get_permissions(self, trans, encoded_library_id, **kwd):
        ...
        * GET /api/libraries/{id}/permissions
        ...
        is_library_access = util.string_as_bool(
            kwd.get('is_library_access', False))
