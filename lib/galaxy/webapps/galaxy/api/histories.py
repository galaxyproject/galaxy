...
def index(
    ...
    return service.index(trans, serialization_params, filter_query_params, deleted_only=deleted, all_histories=all)
...
def index_deleted(
    ...
    return service.index(trans, serialization_params, filter_query_params, deleted_only=True, all_histories=all)
...
def published(
    ...
    return service.published(trans, serialization_params, filter_query_params)
...
def shared_with_me(
    ...
    return service.shared_with_me(trans, serialization_params, filter_query_params)
...
def get_archived_histories(
    ...
    """
    archived_histories, total_matches = service.get_archived_histories(
...
def show_recent(
    ...
    return service.show(trans, serialization_params)
...
def show(
    ...
    return service.show(trans, serialization_params, history_id)
...
def prepare_store_download(
    ...
    return service.prepare_download(
        trans,
        history_id,
        payload=payload,
    )
...
def citations(
    ...
    return service.citations(trans, history_id)
...
def create(
    ...
    return service.create(trans, payload, serialization_params)
...
def delete(
    ...
    if payload:
        purge = payload.purge
    return service.delete(trans, history_id, serialization_params, purge)
...
def undelete(
    ...
    return service.undelete(trans, history_id, serialization_params)
...
def update(
    ...
    return service.update(trans, history_id, payload, serialization_params)
...
def create_from_store(
    ...
    return service.create_from_store(trans, payload, serialization_params)
...
def create_from_store_async(
    ...
    return service.create_from_store_async(trans, payload)
...
def index_exports(
    ...
    exports = service.index_exports(trans, history_id, use_tasks, limit, offset)
    if use_tasks:
...
def archive_export(
    ...
    **Deprecation notice**: Please use `/api/histories/{id}/prepare_store_download` or
    ...
    """
    export_result, ready = service.archive_export(trans, history_id, payload)
    if not ready:
...
def archive_download(
    ...
    **Deprecation notice**: Please use `/api/histories/{id}/prepare_store_download` or
    `/api/histories/{id}/write_store` instead.
    """
    jeha = service.get_ready_history_export(trans, history_id, jeha_id)
    media_type = service.get_archive_media_type(jeha)
    file_path = service.get_archive_download_path(trans, jeha)
...
def get_custom_builds_metadata(
    ...
    return service.get_custom_builds_metadata(trans, history_id)
...
def archive_history(
    ...
    """
    return service.archive_history(trans, history_id, payload)
...
def restore_archived_history(
    ...
    **Warning**: Please note that histories that are associated with an archive export might be purged after export, so un-archiving them
    ...
    """
    return service.restore_archived_history(trans, history_id, force)
...
def sharing(
    ...
    return service.shareable_service.sharing(trans, history_id)
...
def enable_link_access(
    ...
    return service.shareable_service.enable_link_access(trans, history_id)
...
def disable_link_access(
    ...
    return service.shareable_service.disable_link_access(trans, history_id)
...
def publish(
    ...
    return service.shareable_service.publish(trans, history_id)
...
def unpublish(
    ...
    return service.shareable_service.unpublish(trans, history_id)
...
def share_with_users(
    ...
    return service.shareable_service.share_with_users(trans, history_id, payload)
...
def set_slug(
    ...
    service.shareable_service.set_slug(trans, history_id, payload)
