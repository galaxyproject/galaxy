...
PATH_DEFAULTS = dict(
    ...
    oidc_config_file=['config/oidc_config.xml', 'config/oidc_config.xml.sample'],
    oidc_backends_config_file=['config/oidc_backends_config.xml', 'config/oidc_backends_config.xml.sample'],
