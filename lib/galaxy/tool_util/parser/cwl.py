...
class CwlToolSource(ToolSource):
    ...
    def _parse_output_data(self, tool: Optional["Tool"], output_instance: "OutputInstance"):
    ...
    def _parse_output_record(self, tool: Optional["Tool"], output_instance: "OutputInstance"):
        name = output_instance.name
    ...
    def _parse_output_array(self, tool: Optional["Tool"], output_instance: "OutputInstance"):
        name = output_instance.name
