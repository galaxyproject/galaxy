"""Pure-logic collection type description system.

Extracted from galaxy.model.dataset_collections.type_description so that
galaxy-tool-util can reason about collection types (matching, subcollections,
mapping) without depending on galaxy-data.
