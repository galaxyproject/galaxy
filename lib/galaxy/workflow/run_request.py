...
class WorkflowRunConfig( object ):
    ...
    def __init__( self, target_history, replacement_dict, copy_inputs_to_history=False, inputs={}, param_map={}, allow_tool_upgrades=False ):
        self.target_history = target_history
        self.replacement_dict = replacement_dict
        self.copy_inputs_to_history = copy_inputs_to_history
        self.inputs = inputs
        self.param_map = param_map
        self.allow_tool_upgrades = allow_tool_upgrades
...
def build_workflow_run_config( trans, workflow, payload ):
    ...
    allow_tool_upgrades = payload.get( 'allow_tool_upgrades', False )
    ...
    run_config = WorkflowRunConfig(
        ...
        param_map=param_map,
        allow_tool_upgrades=allow_tool_upgrades
    )
    return run_config
