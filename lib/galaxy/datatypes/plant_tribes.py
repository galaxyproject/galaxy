...
class Smat(Text):
    ...
    def display_peek(self, dataset):
        try:
            ...
            return "ESTScan scores matrices (%s)" % (
...
class PlantTribesOrtho(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesOrtho, self).set_peek(
...
class PlantTribesOrthoCodingSequence(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesOrthoCodingSequence, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesTargetedGeneFamilies(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesTargetedGeneFamilies, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesPhylogeneticTree(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesPhylogeneticTree, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesPhylip(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesPhylip, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignment(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignment, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignmentCodonAlignment(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignmentCodonAlignment,
              self).set_peek(
                  dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignmentTrimmed(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignmentTrimmed, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignmentTrimmedCodonAlignment(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignmentTrimmedCodonAlignment,
              self).set_peek(
                  dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignmentFiltered(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignmentFiltered, self).set_peek(
            dataset, is_multi_byte=is_multi_byte)
...
class PlantTribesMultipleSequenceAlignmentFilteredCodonAlignment(PlantTribes):
    ...
    def set_peek(self, dataset, is_multi_byte=False):
        super(PlantTribesMultipleSequenceAlignmentFilteredCodonAlignment,
              self).set_peek(
                  dataset, is_multi_byte=is_multi_byte)
