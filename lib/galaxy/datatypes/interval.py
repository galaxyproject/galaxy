...
class Interval(Tabular):
    ...
    def set_meta(self, dataset, overwrite=True, first_line_is_header=False, **kwd) -> None:
...
class IntervalTabix(Interval):
    ...
    def set_meta(self, dataset, overwrite=True, first_line_is_header=False, metadata_tmp_files_dir=None, **kwd) -> None:
