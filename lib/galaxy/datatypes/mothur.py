...
class GroupAbund(Otu):
    ...
    def set_meta(self, dataset, overwrite=True, skip=1, **kwd) -> None:
        super().set_meta(dataset, overwrite=overwrite, **kwd)
...
class DistanceMatrix(Text):
    ...
    def set_meta(self, dataset, overwrite=True, skip=0, **kwd) -> None:
...
class PairwiseDistanceMatrix(DistanceMatrix, Tabular):
    ...
    def set_meta(self, dataset, overwrite=True, skip=None, **kwd) -> None:
        super().set_meta(dataset, overwrite=overwrite, skip=skip, **kwd)
...
class Group(Tabular):
    ...
    def set_meta(self, dataset, overwrite=True, skip=None, max_data_lines=None, **kwd) -> None:
...
class CountTable(Tabular):
    ...
    def set_meta(self, dataset, overwrite=True, skip=1, max_data_lines=None, **kwd) -> None:
        super().set_meta(dataset, overwrite=overwrite, **kwd)
