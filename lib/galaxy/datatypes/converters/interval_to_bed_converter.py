...
def __main__():
    ...
    count = 0
    for region in bx.intervals.io.GenomicIntervalReader( open(input_name, 'r' ), chrom_col=chromCol, start_col=startCol, end_col=endCol, strand_col=strandCol, fix_strand=True, return_header=False):
