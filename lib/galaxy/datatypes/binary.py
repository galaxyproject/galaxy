...
class Biom2(H5):
    ...
    MetadataElement(name="nnz", default=None, desc="nnz: The number of non-zero elements in the table", readonly=True, visible=True, no_value=None)
    MetadataElement(name="shape", default=None, desc="shape: The number of rows and columns in the dataset", readonly=True, visible=True, no_value=None)
    ...
    def set_meta(self, dataset, overwrite=True, **kwd):
        ...
        try:
            ...
            dataset.metadata.nnz = str(attributes['nnz'])
