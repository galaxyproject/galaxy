...
class H5_Model(H5):
    """
    Machine learning models generated by Galaxy-ML.
    """
    file_ext = "h5_model"

    MetadataElement(name="params", desc="Hyperparameter File", param=FileParameter, file_ext="tabular", readonly=True, no_value=None, visible=False, optional=True)

    def set_meta(self, dataset, overwrite=True, **kwd):
        try:
            spec_key = "params"
            params_file = dataset.metadata.params
            if not params_file:
