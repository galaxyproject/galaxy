...
def upgrade(migrate_engine):
    ...
    metadata.reflect()
    try:
        Implicitly_converted_table = Table(
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping ldda_parent_id column from implicitly_converted_dataset_association table failed."
        )
