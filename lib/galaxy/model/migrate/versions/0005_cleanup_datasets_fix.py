...
from sqlalchemy import datatypes_registry
from sqlalchemy import MetadataCollection
...
def upgrade(migrate_engine):
    ...
    for dataset in context.query( Dataset ).filter( and_( Dataset.deleted is True, Dataset.purged is False ) ):
