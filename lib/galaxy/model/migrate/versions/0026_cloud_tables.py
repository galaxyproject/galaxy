...
UCI_table = Table("cloud_uci", metadata,
                  ...
                  Column(
                      "credentials_id",
                      Integer,
                      ForeignKey("cloud_user_credentials.id"),
                      index=True),
...
CloudInstance_table = Table(
    ...
    Column("security_group", TEXT), Column("availability_zone", TEXT))
