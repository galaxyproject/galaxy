...
from galaxy.model.triggers import history_update_time_field as old_triggers  # rollback to old ones
from galaxy.model.triggers import update_audit_table as new_triggers  # install me
