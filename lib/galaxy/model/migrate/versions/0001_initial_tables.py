...
JobParameter_table = Table("job_parameter", metadata,
                           ...
                           Column(
                               ...
                               ForeignKey("job.id"),
                               index=True),
                           Column("name", String(255)), Column("value", TEXT))
...
Event_table = Table("event", metadata,
                    ...
                    Column(
                        ...
                        ForeignKey("galaxy_session.id"),
                        index=True,
                        nullable=True), Column("tool_id", String(255)))
...
StoredWorkflow_table = Table(
    ...
    Column(
        ...
        index=True),
    Column("name", TEXT), Column("deleted", Boolean, default=False))

Workflow_table = Table("workflow", metadata,
                       Column("id", Integer, primary_key=True),
                       Column("create_time", DateTime, default=now),
                       Column(
                           "update_time", DateTime, default=now, onupdate=now),
                       Column(
                           "stored_workflow_id",
                           Integer,
