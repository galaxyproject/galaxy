...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Adding ldda_id column to implicitly_converted_dataset_association table failed."
        )
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping ldda_id column from implicitly_converted_dataset_association table failed."
        )
