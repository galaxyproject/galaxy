...
def upgrade(migrate_engine):
    ...
    try:
        ...
        if migrate_engine.name == 'mysql' and \
            ...
            i = Index("ix_hda_rating_association_hda_id",
                      HistoryDatasetAssociationRatingAssociation_table.c.
                      history_dataset_association_id)
            try:
                i.create()
            except Exception:
    ...
    try:
        ...
        log.exception(
            "Creating stored_workflow_rating_association table failed.")
    ...
    try:
        ...
        log.exception(
            "Creating visualization_rating_association table failed.")
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping history_dataset_association_rating_association table failed."
        )
    ...
    try:
        ...
        log.exception(
            "Dropping stored_workflow_rating_association table failed.")
    ...
    try:
        ...
        log.exception(
            "Dropping visualization_rating_association table failed.")
