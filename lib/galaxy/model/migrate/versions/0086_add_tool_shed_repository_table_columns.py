...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Adding metadata column to the tool_shed_repository table failed.")
    ...
    try:
        ...
        log.exception(
            "Adding includes_datatypes column to the tool_shed_repository table failed."
        )
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping column metadata from the tool_shed_repository table failed."
        )
    ...
    if migrate_engine.name != 'sqlite':
        try:
            ...
            log.exception(
                "Dropping column includes_datatypes from the tool_shed_repository table failed."
            )
        try:
