...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Creating stored_workflow_annotation_association table failed.")
    ...
    try:
        ...
        log.exception(
            "Creating workflow_step_annotation_association table failed.")
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping stored_workflow_annotation_association table failed.")
    ...
    try:
        ...
        log.exception(
            "Dropping workflow_step_annotation_association table failed.")
