...
DatasetCollectionElement_table = Table(
    ...
    Column("element_index", Integer, nullable=False), Column("element_identifier", Unicode(255), nullable=False))
...
HiddenBeneathCollection_column = Column(
    "hidden_beneath_collection_instance_id", Integer, ForeignKey("history_dataset_collection_association.id"), nullable=True)
