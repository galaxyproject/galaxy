...
class HistoryDatasetCollectionJobStateSummary:
    __view__ = View(
        "collection_job_state_summary_view", metadata,
        Column('hdca_id', Integer, primary_key=True),
        Column('new', Integer),
...
# map the summary view
mapper(HistoryDatasetCollectionJobStateSummary, HistoryDatasetCollectionJobStateSummary.__view__)
