...
def downgrade():
    with transaction():
        ...
        add_column(job_to_input_dataset_table, "adapter")
        add_column(job_to_input_dataset_collection_table, "adapter")
        add_column(job_to_input_dataset_collection_element_table, "adapter")
