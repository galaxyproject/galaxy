...
install_model.ToolShedRepository.table = Table("tool_shed_repository", metadata,
                                               ...
                                               Column("status", TrimmedString(255)), Column("error_message", TEXT))
...
install_model.ToolDependency.table = Table("tool_dependency", metadata,
                                           ...
                                           Column("status", TrimmedString(255), nullable=False), Column("error_message", TEXT))
...
install_model.MigrateTools.table = Table("migrate_tools", metadata,
                                         ...
                                         Column("repository_path", TEXT), Column("version", Integer))
...
mapper(
    ...
    properties=dict(
        ...
        required_repositories=relation(
            ...
            primaryjoin=(install_model.ToolShedRepository.table.c.id ==
...
mapper(
    ...
    properties=dict(
        repository=relation(
            install_model.ToolShedRepository,
            primaryjoin=(install_model.RepositoryRepositoryDependencyAssociation.table.c.tool_shed_repository_id ==
                         install_model.ToolShedRepository.table.c.id)),
        repository_dependency=relation(
            install_model.RepositoryDependency,
            primaryjoin=(install_model.RepositoryRepositoryDependencyAssociation.table.c.repository_dependency_id ==
                         install_model.RepositoryDependency.table.c.id))))

mapper(
    install_model.RepositoryDependency,
    install_model.RepositoryDependency.table,
    properties=dict(repository=relation(
        install_model.ToolShedRepository,
