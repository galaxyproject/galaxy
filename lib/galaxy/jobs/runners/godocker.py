...
class Godocker(object):
    ...
    def http_post_request(self, query, data, header):
        ...
        try:
            ...
            log.error('A transport error occurred in the GoDocker job runner:',
                      e)
            return False
...
class GodockerJobRunner(AsynchronousJobRunner):
    ...
    def __init__(self, app, nworkers, **kwargs):
        ...
        self.auth = self.login(self.runner_params["key"],
    ...
    def check_watched_item(self, job_state):
        ...
        log.debug("Job ID: " + str(job_state.job_id) + " Job Status: " +
    ...
    def create_log_file(self, job_state, job_status_god):
        ...
        if path:
            ...
            try:
                ...
                log.debug("CREATE EXIT CODE FILE: " +
                          str(job_state.exit_code_file))
            except IOError as e:
    ...
    def login(self, apikey, login, server, noCert=False):
        ...
        auth = g_auth.http_post_request("/api/1.0/authenticate", data, {
    ...
    def post_task(self, job_wrapper):
        ...
        if self.auth.token:
            ...
            try:
                ...
                log.error("Unable to find docker_image for job %s, failing." %
                          job_wrapper.job_id)
                return False
