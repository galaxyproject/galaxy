...
def build_command(
    ...
    container_montior_command = job_wrapper.container_montior_command(container)
    if container_montior_command:
        commands_builder.prepend_command(container_montior_command)
