...
from galaxy.tool_shed.galaxy_install.tool_dependencies.recipe import (
    step_handler,
    tag_handler,
)
...
class StepManager:
    ...
    def prepare_step(
        self, tool_dependency, action_type, action_elem, action_dict, install_environment, is_binary_download
    ):
        """
