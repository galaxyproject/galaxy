...
CAPTION_EXAMPLE_2_MAPPED = (
    "The rule builder showing automatically detected list identifier, URI, and type column mappings"
)
CAPTION_EXAMPLE_3_MAPPED = "The rule builder showing automatic paired data detection - notice the data has been split with forward/reverse identifiers added"
CAPTION_EXAMPLE_4_MAPPED = "The rule builder showing automatic nested structure detection from multiple list identifier columns and paired URL columns"
