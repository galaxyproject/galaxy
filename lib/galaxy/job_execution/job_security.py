...
def _compute_resource_id_from_params(params: Mapping[str, object]) -> int | None:
...
def job_files_kind_for_params(destination_params: Mapping[str, object] | None) -> str:
...
def job_token_kind_for_params(destination_params: Mapping[str, object] | None) -> str:
...
def resolve_job_key(authorization_header: str | None, fallback: str | None) -> str | None:
