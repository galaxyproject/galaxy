...
class ResponseMetadata(BaseModel):
    ...
    agents_used: Optional[list[str]] = Field(default=None, description="List of agent types used in orchestration")
    execution_type: Optional[str] = Field(
        default=None, description="Orchestration execution type: 'sequential' or 'parallel'"
    )
    ...
    requires: Optional[str] = Field(
        default=None, description="Capability required but not available (e.g. 'structured_output')"
    )
    ...
    static_backend: Optional[bool] = Field(
        default=None, description="Whether this response came from the static test backend"
    )
    summary: Optional[str] = Field(default=None, description="Summary of the agent's response or reasoning")
    tool_id: Optional[str] = Field(default=None, description="ID of any tool generated by the agent")
