...
class HelpForumTopic(Model):
    ...
    unpinned: Annotated[bool, Field(description="Whether the topic is unpinned.")]
    ...
    bookmarked: Annotated[bool, Field(description="Whether the topic is bookmarked.")]
    liked: Annotated[bool, Field(description="Whether the topic is liked.")]
    tags: Annotated[List[str], Field(description="The tags of the topic.")]
    tags_descriptions: Annotated[List[str], Field(description="The descriptions of the tags of the topic.")]
