...
class ComputedGalaxyConfig(Model):
    ...
    markdown_to_pdf_available: Annotated[
        ...
        Field(
            ...
            description="""Determines if the markdown to pdf conversion is available. **Deprecated**: This is deprecated and will be removed in a future release.""",
        ),
    ] = False
...
class AdminOnlyComputedGalaxyConfig(ComputedGalaxyConfig):
    ...
    tool_shed_urls: Annotated[
        ...
        Field(
            ...
            description="""List of Tool Shed URLs to search for tools. This is a list of fully qualified URLs (e.g., https://toolshed.g2.bx.psu.edu/).""",
        ),
    ] = []
...
PanelViewField = Field(
    title="Panel Views",
    description="""Definitions of static toolbox panel views embedded directly in the config instead of reading YAML from directory with panel_views_dir.""",
)
...
class ExposableGalaxyConfig(Model):
    ...
    enable_tool_recommendations: Annotated[
        ...
        Field(
            ...
            description="""Allow the display of tool recommendations in workflow editor and after tool execution. If it is enabled and set to true, please enable 'tool_recommendation_model_path' as well""",
        ),
    ] = False
    ...
    admin_tool_recommendations_path: Annotated[
        ...
        Field(
            ...
            description="""Set path to the additional tool preferences from Galaxy admins. It has two blocks. One for listing deprecated tools which will be removed from the recommendations and another is for adding additional tools to be recommended along side those from the deep learning model.""",
        ),
    ...
    use_remote_user: Annotated[
        ...
        Field(
            ...
            description="""User authentication can be delegated to an upstream proxy server (usually Apache). The upstream proxy should set a REMOTE_USER header in the request. Enabling remote user disables regular logins. For more information, see: https://docs.galaxyproject.org/en/master/admin/special_topics/apache.html""",
        ),
    ] = False
    ...
    single_user: Annotated[
        ...
        Field(
            title="Single User",
            description="""If an e-mail address is specified here, it will hijack remote user mechanics (``use_remote_user``) and have the webapp inject a single fixed user. This has the effect of turning Galaxy into a single user application with no login or external proxy required. Such applications should not be exposed to the world.""",
        ),
    ] = None
    ...
    plausible_server: Annotated[
        ...
        Field(
            ...
            description="""Please enter the URL for the Plausible server (including https) so this can be used for tracking with Plausible (https://plausible.io/).""",
        ),
    ] = None
    ...
    plausible_domain: Annotated[
        ...
        Field(
            ...
            description="""Please enter the URL for the Galaxy server so this can be used for tracking with Plausible (https://plausible.io/).""",
        ),
    ] = None
    ...
    matomo_server: Annotated[
        ...
        Field(
            title="Matomo Server",
            description="""Please enter the URL for the Matomo server (including https) so this can be used for tracking with Matomo (https://matomo.org/).""",
        ),
    ] = None
    ...
    matomo_site_id: Annotated[
        ...
        Field(
            ...
            description="""Please enter the site ID for the Matomo server so this can be used for tracking with Matomo (https://matomo.org/).""",
        ),
    ] = None
    ...
    enable_beta_markdown_export: Annotated[
        ...
        Field(
            ...
            description="""Enable export of Galaxy Markdown documents (pages and workflow reports) to PDF. Requires manual installation and setup of weasyprint (latest version available for Python 2.7 is 0.42).""",
        ),
    ] = False
    ...
    simplified_workflow_run_ui_job_cache: Annotated[
        ...
        Field(
            ...
            description="""When the simplified workflow run form is rendered, should the invocation use job caching. This isn't a boolean so an option for 'show-selection' can be added later.""",
        ),
    ] = "off"
    ...
    chunk_upload_size: Annotated[
        ...
        Field(
            ...
            description="""Galaxy can upload user files in chunks without using nginx. Enable the chunk uploader by specifying a chunk size larger than 0. The chunk size is specified in bytes (default: 10MB).""",
        ),
    ] = 10485760
    ...
    aws_estimate: Annotated[
        ...
        Field(
            title="Aws Estimate",
            description="""This flag enables an AWS cost estimate for every job based on their runtime matrices. CPU, RAM and runtime usage is mapped against AWS pricing table. Please note, that those numbers are only estimates.""",
        ),
    ] = False
    ...
    power_usage_effectiveness: Annotated[
        ...
        Field(
            ...
            description="""The estimated power usage effectiveness of the data centre housing the server your galaxy instance is running on. This can make carbon emissions estimates more accurate. For more information on how to calculate a PUE value, visit https://en.wikipedia.org/wiki/Power_usage_effectiveness""",
        ),
    ] = 1.67
    ...
    message_box_class: Annotated[
        ...
        Field(
            ...
            description="""Class of the message box under the masthead. Possible values are: 'info' (the default), 'warning', 'error', 'done'.""",
        ),
    ] = "info"
    ...
    mailing_join_addr: Annotated[
        ...
        Field(
            ...
            description="""On the user registration form, users may choose to join a mailing list. This is the address used to subscribe to the list. Uncomment and leave empty if you want to remove this option from the user registration form. Example value 'galaxy-announce-join@lists.galaxyproject.org'""",
        ),
    ...
    cookie_domain: Annotated[
        ...
        Field(
            title="Cookie Domain",
            description="""Tell Galaxy that multiple domains sharing the same root are associated to this instance and wants to share the same session cookie. This allow a user to stay logged in when passing from one subdomain to the other. This root domain will be written in the unique session cookie shared by all subdomains.""",
        ),
    ]
    ...
    toolbox_auto_sort: Annotated[
        ...
        Field(
            ...
            description="""If true, the toolbox will be sorted by tool id when the toolbox is loaded. This is useful for ensuring that tools are always displayed in the same order in the UI. If false, the order of tools in the toolbox will be preserved as they are loaded from the tool config files.""",
        ),
    ] = True
    ...
    default_panel_view: Annotated[
        ...
        Field(
            ...
            description="""Default tool panel view for the current Galaxy configuration. This should refer to an id of a panel view defined using the panel_views or panel_views_dir configuration options or an EDAM panel view. The default panel view is simply called `default` and refers to the tool panel state defined by the integrated tool panel.""",
        ),
    ] = "default"
    ...
    enable_tool_source_display: Annotated[
        ...
        Field(
            ...
            description="""This option allows users to view the tool wrapper source code. This is safe to enable if you have not hardcoded any secrets in any of the tool wrappers installed on this Galaxy server. If you have only installed tool wrappers from public tool sheds and tools shipped with Galaxy there you can enable this option.""",
        ),
    ] = False
    ...
    enable_celery_tasks: Annotated[
        ...
        Field(
            ...
            description="""Offload long-running tasks to a Celery task queue. Activate this only if you have setup a Celery worker for Galaxy. For details, see https://docs.galaxyproject.org/en/master/admin/production.html""",
        ),
    ] = False
    ...
    welcome_directory: Annotated[
        ...
        Field(
            ...
            description="""Location of New User Welcome data, a single directory containing the images and JSON of Topics/Subtopics/Slides as export. This location is relative to galaxy/static""",
        ),
    ...
    tool_training_recommendations: Annotated[
        ...
        Field(
            ...
            description="""Displays a link to training material, if any includes the current tool. When activated the following options also need to be set: tool_training_recommendations_link, tool_training_recommendations_api_url""",
        ),
    ] = True
    ...
    tool_training_recommendations_link: Annotated[
        ...
        Field(
            ...
            description="""Template URL to display all tutorials containing current tool. Valid template inputs are: {repository_owner} {name} {tool_id} {training_tool_identifier} {version}""",
        ),
    ...
    tool_training_recommendations_api_url: Annotated[
        ...
        Field(
            ...
            description="""URL to API describing tutorials containing specific tools. When CORS is used, make sure to add this host.""",
        ),
...
class AdminExposableGalaxyConfig(ExposableGalaxyConfig):
    ...
    allow_library_path_paste: Annotated[
        ...
        Field(
            ...
            description="""Adds an option to the admin library upload tool allowing admins to paste filesystem paths to files and directories in a box, and these paths will be added to a library.""",
        ),
    ] = False
...
class FullGalaxyConfig(AdminExposableGalaxyConfig, SchemaCompatibleConfigValues):
    ...
    config_dir: Annotated[
        ...
        Field(
            title="Config Dir",
            description="""The directory that will be prepended to relative paths in options specifying other Galaxy config files (e.g. datatypes_config_file). Defaults to the directory in which galaxy.yml is located.""",
        ),
    ] = None
    ...
    managed_config_dir: Annotated[
        ...
        Field(
            ...
            description="""The directory that will be prepended to relative paths in options specifying config files controlled by Galaxy (such as shed_tool_config_file, etc.). Must be writable by the user running Galaxy. Defaults to `<config_dir>/` if running Galaxy from source or `<data_dir>/config` otherwise.""",
        ),
    ] = None
    ...
    data_dir: Annotated[
        ...
        Field(
            title="Data Dir",
            description="""The directory that will be prepended to relative paths in options specifying Galaxy data/cache directories and files (such as the default SQLite database, file_path, etc.). Defaults to `database/` if running Galaxy from source or `<config_dir>/data` otherwise.""",
        ),
    ] = None
    ...
    cache_dir: Annotated[
        ...
        Field(
            ...
            title="Cache Dir",
            description="""Top level cache directory. Any other cache directories (tool_cache_data_dir, template_cache_path, etc.) should be subdirectories.""",
        ),
    ] = "cache"
    ...
    enable_per_request_sql_debugging: Annotated[
        ...
        Field(
            ...
            description="""Enables a per request sql debugging option. If this is set to true, append ?sql_debug=1 to web request URLs to enable detailed logging on the backend of SQL queries generated during that request. This is useful for debugging slow endpoints during development.""",
        ),
    ] = False
    ...
    history_audit_table_prune_interval: Annotated[
        ...
        Field(
            ...
            description="""Time (in seconds) between attempts to remove old rows from the history_audit database table. Set to 0 to disable pruning.""",
        ),
    ] = 3600
    ...
    new_file_path: Annotated[
        ...
        Field(
            path_resolves_to=DATA_DIR,
            title="New File Path",
            description="""Where temporary files are stored. It must be accessible at the same path on any cluster nodes that will run Galaxy jobs, unless using Pulsar.""",
        ),
    ] = "tmp"
    ...
    maximum_upload_file_size: Annotated[
        ...
        Field(
            ...
            description="""Maximum size of uploadable files, specified in bytes (default: 100GB). This value is ignored if an external upload server is configured.""",
        ),
    ] = 107374182400
    ...
    tool_config_file: Annotated[
        ...
        Field(
            ...
            description="""Tool config files, defines what tools are available in Galaxy. Tools can be locally developed or installed from Galaxy tool sheds. (config/tool_conf.xml.sample will be used if left unset and config/tool_conf.xml does not exist). Can be a single file, a list of files, or (for backwards compatibility) a comma-separated list of files.""",
        ),
    ] = "tool_conf.xml"
    ...
    shed_tool_config_file: Annotated[
        ...
        Field(
            ...
            description="""Tool config file for tools installed from the Galaxy Tool Shed. Must be writable by Galaxy and generally should not be edited by hand. In older Galaxy releases, this file was part of the tool_config_file option. It is still possible to specify this file (and other shed-enabled tool config files) in tool_config_file, but in the standard case of a single shed-enabled tool config, this option is preferable. This file will be created automatically upon tool installation, whereas Galaxy will fail to start if any files in tool_config_file cannot be read.""",
        ),
    ] = "shed_tool_conf.xml"
    ...
    migrated_tools_config: Annotated[
        ...
        Field(
            ...
            description="""This option is deprecated. In previous releases this file was maintained by tool migration scripts that are no longer part of the code base. The option remains as a placeholder for deployments where these scripts were previously run and such a file exists.""",
        ),
    ...
    dependency_resolvers_config_file: Annotated[
        ...
        Field(
            ...
            description="""Specifies the path to the standalone dependency resolvers configuration file. This configuration can now be specified directly in the Galaxy configuration, see the description of the 'dependency_resolvers' option for details.""",
        ),
    ...
    conda_prefix: Annotated[
        ...
        Field(
            title="Conda Prefix",
            description="""conda_prefix is the location on the filesystem where Conda packages and environments are installed. Sample default '<tool_dependency_dir>/_conda'""",
        ),
    ] = None
    ...
    conda_ensure_channels: Annotated[
        ...
        Field(
            ...
            description="""conda channels to enable by default (https://conda.io/docs/user-guide/tasks/manage-channels.html)""",
        ),
    ...
    local_conda_mapping_file: Annotated[
        ...
        Field(
            ...
            description="""Path to a file that provides a mapping from abstract packages to concrete conda packages. See `config/local_conda_mapping.yml.sample` for examples.""",
        ),
    ...
    modules_mapping_files: Annotated[
        ...
        Field(
            ...
            description="""Path to a file that provides a mapping from abstract packages to locally installed modules. See `config/environment_modules_mapping.yml.sample` for examples.""",
        ),
    ...
    tool_dependency_cache_dir: Annotated[
        ...
        Field(
            ...
            description="""By default the tool_dependency_cache_dir is the _cache directory of the tool dependency directory. Sample default '<tool_dependency_dir>/_cache'""",
        ),
    ] = None
    ...
    watch_job_rules: Annotated[
        ...
        Field(
            ...
            description="""Monitor dynamic job rules. If changes are found, rules are automatically reloaded. Takes the same values as the 'watch_tools' option.""",
        ),
    ] = "false"
    ...
    watch_core_config: Annotated[
        ...
        Field(
            ...
            description="""Monitor a subset of options in the core configuration file (See RELOADABLE_CONFIG_OPTIONS in lib/galaxy/config/__init__.py). If changes are found, modified options are automatically reloaded. Takes the same values as the 'watch_tools' option.""",
        ),
    ] = "false"
    ...
    watch_tours: Annotated[
        ...
        Field(
            title="Watch Tours",
            description="""Monitor the interactive tours directory specified in the 'tour_config_dir' option. If changes are found, modified tours are automatically reloaded. Takes the same values as the 'watch_tools' option.""",
        ),
    ] = "false"
    ...
    short_term_storage_dir: Annotated[
        ...
        Field(
            ...
            description="""Location of files available for a short time as downloads (short term storage). This directory is exclusively used for serving dynamically generated downloadable content. Galaxy may uses the new_file_path parameter as a general temporary directory and that directory should be monitored by a tool such as tmpwatch in production environments. short_term_storage_dir on the other hand is monitored by Galaxy's task framework and should not require such external tooling.""",
        ),
    ...
    short_term_storage_default_duration: Annotated[
        ...
        Field(
            ...
            description="""Default duration before short term web storage files will be cleaned up by Galaxy tasks (in seconds). The default duration is 1 day.""",
        ),
    ] = 86400
    ...
    short_term_storage_maximum_duration: Annotated[
        ...
        Field(
            ...
            description="""The maximum duration short term storage files can hosted before they will be marked for clean up. The default setting of 0 indicates no limit here.""",
        ),
    ] = 0
    ...
    short_term_storage_cleanup_interval: Annotated[
        ...
        Field(
            ...
            description="""How many seconds between instances of short term storage being cleaned up in default Celery task configuration.""",
        ),
    ] = 3600
    ...
    enable_mulled_containers: Annotated[
        ...
        Field(
            ...
            description="""Enable Galaxy to fetch containers registered with quay.io generated from tool requirements resolved through Conda. These containers (when available) have been generated using mulled - https://github.com/mulled. Container availability will vary by tool, this option will only be used for job destinations with Docker or Singularity enabled.""",
        ),
    ] = True
    ...
    container_resolvers: Annotated[
        ...
        Field(
            ...
            description="""Rather than specifying a container_resolvers_config_file, the definition of the resolvers to enable can be embedded into Galaxy's config with this option. This has no effect if a container_resolvers_config_file is used. Takes the same options that can be set in container_resolvers_config_file.""",
        ),
    ] = None
    ...
    involucro_auto_init: Annotated[
        ...
        Field(
            ...
            description="""Install involucro as needed to build Docker or Singularity containers for tools. Ignored if relevant container resolver is not used.""",
        ),
    ] = True
    ...
    shed_tool_data_path: Annotated[
        ...
        Field(
            ...
            description="""Directory where Tool Data Table related files will be placed when installed from a ToolShed. Defaults to the value of the 'tool_data_path' option.""",
        ),
    ] = None
    ...
    build_sites_config_file: Annotated[
        ...
        Field(
            ...
            description="""File that defines the builds (dbkeys) available at sites used by display applications and the URL to those sites.""",
        ),
    ] = "build_sites.yml"
    ...
    builds_file_path: Annotated[
        ...
        Field(
            ...
            description="""File containing old-style genome builds. The value of this option will be resolved with respect to <tool_data_path>.""",
        ),
    ...
    len_file_path: Annotated[
        ...
        Field(
            title="Len File Path",
            description="""Directory where chrom len files are kept, currently mainly used by trackster. The value of this option will be resolved with respect to <tool_data_path>.""",
        ),
    ] = "shared/ucsc/chrom"
    ...
    sniff_compressed_dynamic_datatypes_default: Annotated[
        ...
        Field(
            ...
            description="""Enable sniffing of compressed datatypes. This can be configured/overridden on a per-datatype basis in the datatypes_conf.xml file. With this option set to false the compressed datatypes will be unpacked before sniffing.""",
        ),
    ] = True
    ...
    visualization_plugins_directory: Annotated[
        ...
        Field(
            ...
            description="""Visualizations config directory: where to look for individual visualization plugins. The path is relative to the Galaxy root dir. To use an absolute path begin the path with '/'. This is a comma-separated list.""",
        ),
    ...
    job_working_directory: Annotated[
        ...
        Field(
            ...
            description="""Each job is given a unique empty directory as its current working directory. This option defines in what parent directory those directories will be created. The value of this option will be resolved with respect to <data_dir>.""",
        ),
    ] = "jobs_directory"
    ...
    tool_cache_data_dir: Annotated[
        ...
        Field(
            ...
            description="""Tool related caching. Fully expanded tools and metadata will be stored at this path. Per tool_conf cache locations can be configured in (``shed_``)tool_conf.xml files using the tool_cache_data_dir attribute.""",
        ),
    ] = "tool_cache"
    ...
    biotools_content_directory: Annotated[
        ...
        Field(
            ...
            description="""Point Galaxy at a repository consisting of a copy of the bio.tools database (e.g. https://github.com/bio-tools/content/) to resolve bio.tools data for tool metadata.""",
        ),
    ] = None
    ...
    biotools_use_api: Annotated[
        ...
        Field(
            ...
            description="""Set this to true to attempt to resolve bio.tools metadata for tools for tool not resolved via biotools_content_directory.""",
        ),
    ] = False
    ...
    biotools_service_cache_url: Annotated[
        ...
        Field(
            ...
            description="""When biotools_service_cache_type = ext:database, this is the url of the database used by beaker for bio.tools web service request related caching. The application config code will set it to the value of database_connection if this is not set.""",
        ),
    ] = None
    ...
    biotools_service_cache_table_name: Annotated[
        ...
        Field(
            ...
            description="""When biotools_service_cache_type = ext:database, this is the database table name used by beaker for bio.tools web service request related caching.""",
        ),
    ] = "beaker_cache"
    ...
    citation_cache_type: Annotated[
        ...
        Field(
            ...
            description="""Citation related caching. Tool citations information maybe fetched from external sources such as https://doi.org/ by Galaxy - the following parameters can be used to control the caching used to store this information.""",
        ),
    ] = "file"
    ...
    citation_cache_url: Annotated[
        ...
        Field(
            ...
            description="""When citation_cache_type = ext:database, this is the url of the database used by beaker for citation caching. The application config code will set it to the value of database_connection if this is not set.""",
        ),
    ] = None
    ...
    citation_cache_table_name: Annotated[
        ...
        Field(
            ...
            description="""When citation_cache_type = ext:database, this is the database table name used by beaker for citation related caching.""",
        ),
    ] = "beaker_cache"
    ...
    citation_cache_schema_name: Annotated[
        ...
        Field(
            ...
            description="""When citation_cache_type = ext:database, this is the database schema name of the table used by beaker for citation related caching.""",
        ),
    ] = None
    ...
    mulled_resolution_cache_type: Annotated[
        ...
        Field(
            ...
            description="""Mulled resolution caching. Mulled resolution uses external APIs of quay.io, these requests are caching using this and the following parameters.""",
        ),
    ] = "file"
    ...
    mulled_resolution_cache_url: Annotated[
        ...
        Field(
            ...
            description="""When mulled_resolution_cache_type = ext:database, this is the url of the database used by beaker for caching mulled resolution requests. The application config code will set it to the value of database_connection if this is not set.""",
        ),
    ] = None
    ...
    object_store_cache_path: Annotated[
        ...
        Field(
            ...
            description="""Default cache path for caching object stores if cache not configured for that object store entry.""",
        ),
    ] = "object_store_cache"
    ...
    object_store_cache_size: Annotated[
        ...
        Field(
            ...
            description="""Default cache size for caching object stores if cache not configured for that object store entry.""",
        ),
    ] = -1
    ...
    mailing_join_subject: Annotated[
        ...
        Field(
            ...
            description="""The subject of the email sent to the mailing list join address. See the `mailing_join_addr` option for more information.""",
        ),
    ] = "Join Mailing List"
    ...
    mailing_join_body: Annotated[
        ...
        Field(
            ...
            description="""The body of the email sent to the mailing list join address. See the `mailing_join_addr` option for more information.""",
        ),
    ] = "Join Mailing List"
    ...
    custom_activation_email_message: Annotated[
        ...
        Field(
            ...
            description="""This text will be inserted at the end of the activation email's message, before the 'Your Galaxy Team' signature.""",
        ),
    ] = None
    ...
    activation_grace_period: Annotated[
        ...
        Field(
            ...
            description="""Activation grace period (in hours). Activation is not forced (login is not disabled) until grace period has passed. Users under grace period can't run jobs. Enter 0 to disable grace period.""",
        ),
    ] = 3
    ...
    interactivetools_proxy_host: Annotated[
        ...
        Field(
            ...
            description="""Hostname and port of Interactive tools proxy. It is assumed to be hosted on the same hostname and port as Galaxy by default.""",
        ),
    ] = None
    ...
    interactivetools_shorten_url: Annotated[
        ...
        Field(
            ...
            description="""Shorten the uuid portion of the subdomain or path for interactive tools. Especially useful for avoiding the need for wildcard certificates by keeping subdomain under 63 chars.""",
        ),
    ] = False
    ...
    display_galaxy_brand: Annotated[
        ...
        Field(
            ...
            description="""This option has been deprecated, use the `logo_src` instead to change the default logo including the galaxy brand title.""",
        ),
    ] = True
    ...
    galaxy_url_prefix: Annotated[
        ...
        Field(
            ...
            description="""URL prefix for Galaxy application. If Galaxy should be served under a prefix set this to the desired prefix value.""",
        ),
    ] = "/"
    ...
    galaxy_infrastructure_url: Annotated[
        ...
        Field(
            ...
            description="""URL (with schema http/https) of the Galaxy instance as accessible within your local network. This URL is used as a default by pulsar file staging and Interactive Tool containers for communicating back with Galaxy via the API. If you plan to run Interactive Tools make sure the docker container can reach this URL.""",
        ),
    ] = "http://localhost:8080"
    ...
    apache_xsendfile: Annotated[
        ...
        Field(
            ...
            description="""For help on configuring the Advanced proxy features, see: https://docs.galaxyproject.org/en/master/admin/production.html  Apache can handle file downloads (Galaxy-to-user) via mod_xsendfile. Set this to true to inform Galaxy that mod_xsendfile is enabled upstream.""",
        ),
    ] = False
    ...
    upstream_gzip: Annotated[
        ...
        Field(
            title="Upstream Gzip",
            description="""If using compression in the upstream proxy server, use this option to disable gzipping of dataset collection and library archives, since the upstream server will do it faster on the fly. To enable compression add ``application/zip`` to the proxy's compressable mimetypes.""",
        ),
    ] = False
    ...
    tus_upload_store: Annotated[
        ...
        Field(
            ...
            description="""The upload store is a temporary directory in which files uploaded by the tus middleware or server will be placed. Defaults to new_file_path if not set.""",
        ),
    ] = None
    ...
    dynamic_proxy_bind_port: Annotated[
        ...
        Field(
            ...
            description="""Set the port and IP for the dynamic proxy to bind to, this must match the external configuration if dynamic_proxy_manage is set to false.""",
        ),
    ] = 8800
    ...
    log_destination: Annotated[
        ...
        Field(
            ...
            description="""Log destination, defaults to special value "stdout" that logs to standard output. If set to anything else, then it will be interpreted as a path that will be used as the log file, and logging to stdout will be disabled.""",
        ),
    ] = "stdout"
    ...
    log_level: Annotated[
        ...
        Field(
            title="Log Level",
            description="""Verbosity of console log messages. Acceptable values can be found here: https://docs.python.org/library/logging.html#logging-levels A custom debug level of "TRACE" is available for even more verbosity.""",
        ),
    ] = "DEBUG"
    ...
    logging: Annotated[
        ...
        Field(
            allowempty=True,
            title="Logging",
            description="""Controls where and how the server logs messages. If set, overrides all settings in the log_* configuration options. Configuration is described in the documentation at: https://docs.galaxyproject.org/en/master/admin/config_logging.html """,
        ),
    ] = None
    ...
    sanitize_allowlist_file: Annotated[
        ...
        Field(
            ...
            description="""Datasets created by tools listed in this file are trusted and will not have their HTML sanitized on display. This can be manually edited or manipulated through the Admin control panel -- see "Manage Allowlist"  The value of this option will be resolved with respect to <managed_config_dir>.""",
        ),
    ...
    serve_xss_vulnerable_mimetypes: Annotated[
        ...
        Field(
            ...
            description="""By default Galaxy will serve non-HTML tool output that may potentially contain browser executable JavaScript content as plain text. This will for instance cause SVG datasets to not render properly and so may be disabled by setting this option to true.""",
        ),
    ] = False
    ...
    debug: Annotated[
        ...
        Field(
            title="Debug",
            description="""Debug enables access to various config options useful for development and debugging: use_lint, use_profile, and use_printdebug. It also causes the files used by PBS/SGE (submission script, output, and error) to remain on disk after the job is complete.""",
        ),
    ] = False
    ...
    heartbeat_interval: Annotated[
        ...
        Field(
            ...
            description="""Control the period (in seconds) between dumps. Use -1 to disable. Regardless of this setting, if use_heartbeat is enabled, you can send a Galaxy process SIGUSR1 (`kill -USR1`) to force a dump.""",
        ),
    ] = 20
    ...
    sentry_event_level: Annotated[
        ...
        Field(
            ...
            description="""Determines the minimum log level that will be sent as an event to Sentry. Possible values are DEBUG, INFO, WARNING, ERROR or CRITICAL.""",
        ),
    ] = "ERROR"
    ...
    sentry_traces_sample_rate: Annotated[
        ...
        Field(
            ...
            description="""Set to a number between 0 and 1. With this option set, every transaction created will have that percentage chance of being sent to Sentry. A value higher than 0 is required to analyze performance.""",
        ),
    ] = 0.0
    ...
    sentry_ca_certs: Annotated[
        ...
        Field(
            ...
            description="""Use this option to provide the path to location of the CA (Certificate Authority) certificate file if the sentry server uses a self-signed certificate.""",
        ),
    ] = None
    ...
    statsd_mock_calls: Annotated[
        ...
        Field(
            ...
            description="""Mock out statsd client calls - only used by testing infrastructure really. Do not set this in production environments.""",
        ),
    ] = False
    ...
    tool_name_boost: Annotated[
        ...
        Field(
            ...
            description="""In tool search, a query match against a tool's name text will receive this score multiplier.""",
        ),
    ] = 20.0
    ...
    tool_name_exact_multiplier: Annotated[
        ...
        Field(
            ...
            description="""If a search query matches a tool name exactly, the score will be multiplied by this factor.""",
        ),
    ] = 10.0
    ...
    tool_section_boost: Annotated[
        ...
        Field(
            ...
            description="""In tool search, a query match against a tool's section text will receive this score multiplier.""",
        ),
    ] = 3.0
    ...
    tool_description_boost: Annotated[
        ...
        Field(
            ...
            description="""In tool search, a query match against a tool's description text will receive this score multiplier.""",
        ),
    ] = 8.0
    ...
    tool_label_boost: Annotated[
        ...
        Field(
            ...
            description="""In tool search, a query match against a tool's label text will receive this score multiplier.""",
        ),
    ] = 1.0
    ...
    tool_stub_boost: Annotated[
        ...
        Field(
            ...
            description="""A stub is parsed from the GUID as "owner/repo/tool_id". In tool search, a query match against a tool's stub text will receive this score multiplier.""",
        ),
    ] = 2.0
    ...
    tool_help_boost: Annotated[
        ...
        Field(
            ...
            description="""In tool search, a query match against a tool's help text will receive this score multiplier.""",
        ),
    ] = 1.0
    ...
    tool_search_limit: Annotated[
        ...
        Field(
            ...
            description="""Limits the number of results in toolbox search. Use to set the maximum number of tool search results to display.""",
        ),
    ] = 20
    ...
    tool_enable_ngram_search: Annotated[
        ...
        Field(
            ...
            description="""Disabling this will prevent partial matches on tool names. Enable/disable Ngram-search for tools. It makes tool search results tolerant for spelling mistakes in the query, and will also match query substrings e.g. "genome" will match "genomics" or "metagenome".""",
        ),
    ] = True
    ...
    tool_ngram_factor: Annotated[
        ...
        Field(
            ...
            description="""Ngram matched scores will be multiplied by this factor. Should always be below 1, because an ngram match is a partial match of a search term.""",
        ),
    ] = 0.2
    ...
    normalize_remote_user_email: Annotated[
        ...
        Field(
            ...
            description="""If your proxy and/or authentication source does not normalize e-mail addresses or user names being passed to Galaxy - set this option to true to force these to lower case.""",
        ),
    ] = False
    ...
    enable_beta_workflow_modules: Annotated[
        ...
        Field(
            ...
            description="""Enable beta workflow modules that should not yet be considered part of Galaxy's stable API. (The module state definitions may change and workflows built using these modules may not function in the future.) """,
        ),
    ] = False
    ...
    edam_panel_views: Annotated[
        ...
        Field(
            ...
            description="""Comma-separated list of the EDAM panel views to load - choose from merged, operations, topics. Set to empty string to disable EDAM all together. Set default_panel_view to 'ontology:edam_topics' to override default tool panel to use an EDAM view.""",
        ),
    ] = "operations,topics"
    ...
    panel_views_dir: Annotated[
        ...
        Field(
            ...
            description="""Directory to check out for toolbox tool panel views. The path is relative to the Galaxy root dir. To use an absolute path begin the path with '/'. This is a comma-separated list.""",
        ),
    ...
    default_workflow_export_format: Annotated[
        ...
        Field(
            ...
            description="""Default format for the export of workflows. Possible values are 'ga' or 'format2'.""",
        ),
    ] = "ga"
    ...
    bootstrap_admin_api_key: Annotated[
        ...
        Field(
            ...
            description="""API key that allows performing some admin actions without actually having a real admin user in the database and config. Only set this if you need to bootstrap Galaxy, in particular to create a real admin user account via API. You should probably not set this on a production server.""",
        ),
    ] = None
    ...
    ga4gh_service_organization_url: Annotated[
        ...
        Field(
            ...
            description="""Organization URL for host organization (exposed via the service-info endpoint for the Galaxy DRS API). If unset, one will be generated using the URL the target API requests are made against.  For more information on GA4GH service definitions - check out https://github.com/ga4gh-discovery/ga4gh-service-registry and https://editor.swagger.io/?url=https://raw.githubusercontent.com/ga4gh-discovery/ga4gh-service-registry/develop/service-registry.yaml """,
        ),
    ] = None
    ...
    ftp_upload_dir: Annotated[
        ...
        Field(
            ...
            description="""This should point to a directory containing subdirectories matching users' identifier (defaults to e-mail), where Galaxy will look for files.""",
        ),
    ] = None
    ...
    ftp_upload_purge: Annotated[
        ...
        Field(
            ...
            description="""Set to false to prevent Galaxy from deleting uploaded FTP files as it imports them.""",
        ),
    ] = True
    ...
    shed_data_manager_config_file: Annotated[
        ...
        Field(
            ...
            description="""File where Tool Shed based Data Managers are configured. This file will be created automatically upon data manager installation.""",
        ),
    ...
    galaxy_data_manager_data_path: Annotated[
        ...
        Field(
            ...
            description="""Directory to store Data Manager based tool-data. Defaults to the value of the <tool_data_path> option.""",
        ),
    ] = None
    ...
    dependency_resolvers: Annotated[
        ...
        Field(
            ...
            description="""Rather than specifying a dependency_resolvers_config_file, the definition of the resolvers to enable can be embedded into Galaxy's config with this option. This has no effect if a dependency_resolvers_config_file is used.  The syntax, available resolvers, and documentation of their options is explained in detail in the documentation:  https://docs.galaxyproject.org/en/master/admin/dependency_resolvers.html """,
        ),
    ] = None
    ...
    dependency_resolution: Annotated[
        ...
        Field(
            ...
            description="""Alternative representation of various dependency resolution parameters. Takes the dictified version of a DependencyManager object - so this is ideal for automating the configuration of dependency resolution from one application that uses a DependencyManager to another.""",
        ),
    ] = None
    ...
    track_jobs_in_database: Annotated[
        ...
        Field(
            ...
            description="""This option is deprecated, use the `mem-self` handler assignment option in the job configuration instead.""",
        ),
    ] = True
    ...
    drmaa_external_runjob_script: Annotated[
        ...
        Field(
            ...
            description="""When running DRMAA jobs as the Galaxy user (https://docs.galaxyproject.org/en/master/admin/cluster.html#submitting-jobs-as-the-real-user) this script is used to run the job script Galaxy generates for a tool execution.  Example value 'sudo -E scripts/drmaa_external_runner.py --assign_all_groups' """,
        ),
    ] = None
    ...
    drmaa_external_killjob_script: Annotated[
        ...
        Field(
            ...
            description="""When running DRMAA jobs as the Galaxy user (https://docs.galaxyproject.org/en/master/admin/cluster.html#submitting-jobs-as-the-real-user) this script is used to kill such jobs by Galaxy (e.g. if the user cancels the job).  Example value 'sudo -E scripts/drmaa_external_killer.py' """,
        ),
    ] = None
    ...
    markdown_export_css: Annotated[
        ...
        Field(
            ...
            description="""CSS file to apply to all Markdown exports to PDF - currently used by WeasyPrint during rendering an HTML export of the document to PDF.""",
        ),
    ] = "markdown_export.css"
    ...
    markdown_export_css_pages: Annotated[
        ...
        Field(
            ...
            description="""CSS file to apply to "Galaxy Page" exports to PDF. Generally prefer markdown_export_css, but this is here for deployments that would like to tailor different kinds of exports.""",
        ),
    ...
    markdown_export_css_invocation_reports: Annotated[
        ...
        Field(
            ...
            description="""CSS file to apply to invocation report exports to PDF. Generally prefer markdown_export_css, but this is here for deployments that would like to tailor different kinds of exports.""",
        ),
    ...
    markdown_export_prologue: Annotated[
        ...
        Field(
            ...
            description="""Prologue Markdown/HTML to apply to markdown exports to PDF. Allowing branded headers.""",
        ),
    ] = ""
    ...
    markdown_export_epilogue: Annotated[
        ...
        Field(
            ...
            description="""Prologue Markdown/HTML to apply to markdown exports to PDF. Allowing branded footers.""",
        ),
    ] = ""
    ...
    markdown_export_prologue_invocation_reports: Annotated[
        ...
        Field(
            ...
            description="""Alternative to markdown_export_prologue that applies just to invocation report exports.""",
        ),
    ] = ""
    ...
    workflow_schedulers_config_file: Annotated[
        ...
        Field(
            ...
            description="""Optional configuration file similar to `job_config_file` to specify which Galaxy processes should schedule workflows.""",
        ),
    ...
    toolbox_filter_base_modules: Annotated[
        ...
        Field(
            ...
            description="""The base module(s) that are searched for modules for toolbox filtering (https://galaxyproject.org/user-defined-toolbox-filters/) functions.""",
        ),
    ...
    celery_user_rate_limit: Annotated[
        ...
        Field(
            ...
            description="""If set to a non-0 value, upper limit on number of tasks that can be executed per user per second.""",
        ),
    ] = 0.0
    ...
    use_pbkdf2: Annotated[
        ...
        Field(
            title="Use Pbkdf2",
            description="""Allow disabling pbkdf2 hashing of passwords for legacy situations. This should normally be left enabled unless there is a specific reason to disable it.""",
        ),
    ] = True
    ...
    themes_config_file: Annotated[
        ...
        Field(
            ...
            description="""Optional file containing one or more themes for galaxy. If several themes are defined, users can choose their preferred theme in the client.""",
        ),
    ] = "themes_conf.yml"
