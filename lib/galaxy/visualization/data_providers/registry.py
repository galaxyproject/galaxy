...
class DataProviderRegistry(object):
    ...
    def __init__(self):
        ...
        self.dataset_type_name_to_data_provider = {
            "tabix": {
                Vcf:
                genome.VcfTabixDataProvider,
                Bed:
                genome.BedTabixDataProvider,
                Gtf:
                genome.GtfTabixDataProvider,
                ENCODEPeak:
                genome.ENCODEPeakTabixDataProvider,
                Interval:
                genome.IntervalTabixDataProvider,
                ChromatinInteractions:
                genome.ChromatinInteractionsTabixDataProvider,
                "default":
                genome.TabixDataProvider
            },
    ...
    def get_data_provider(self,
        ...
        if raw:
            ...
            elif isinstance(original_dataset.datatype, (Nexus, Newick,
                                                        Phyloxml)):
            ...
            if name:
                ...
                if isinstance(value, dict):
                    ...
                    data_provider_class = value.get(
                        original_dataset.datatype.__class__,
                        value.get("default"))
                else:
