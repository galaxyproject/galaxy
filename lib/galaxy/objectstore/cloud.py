...
class Cloud( ObjectStore ):
    ...
    def _in_cache(self, rel_path):
        ...
        #         # print "File '%s' cache size: %s, S3 size: %s" % (cache_path, os.path.getsize(cache_path), self._get_size_in_cloud(rel_path))
        #         if os.path.getsize(cache_path) == self._get_size_in_cloud(rel_path):
