...
def best_match(supported, header):
    ...
    weighted_matches = [(fitness_and_quality_parsed(mime_type, parsed_header),
                         mime_type) for mime_type in supported]
...
if __name__ == "__main__":
    ...
    class TestMimeParsing(unittest.TestCase):
        ...
        def test_support_wildcards(self):
            ...
            self.assertEqual(
                best_match(mime_types_supported, 'image/*'), 'image/*')
