...
class GalaxyWebTransaction_Headers_TestCase(unittest.TestCase):
    ...
    def test_parse_allowed_origin_hostnames(self):
        ...
        # re._pattern_type has been moved to re.Pattern on python 3.7
        pattern_type = getattr(re, '_pattern_type', re.Pattern)
        self.assertTrue(isinstance(hostnames[0], pattern_type))
