...
class _StubDataset:
    ...
    def __init__(self, *, file_path: str, extra_files_path: str | None = None) -> None:
...
class _StubJob:
    ...
    def __init__(
        ...
        *,
        ...
        input_datasets: list[_StubAssoc] | None = None,
        output_datasets: list[_StubAssoc] | None = None,
    ) -> None:
        self.id = id
        self.state = state
        # ``JobWorkingDirectory`` consults this first; ``None`` falls through
        # to the object-store-derived path the stub object store returns.
