...
@patch_url_for
def test_reset_dm_with_uninstallable_revisions(shed_app: TestToolShedApp, new_repository: Repository):
    upload_directories_to_repository(shed_app, new_repository, "data_manager_gaps")
