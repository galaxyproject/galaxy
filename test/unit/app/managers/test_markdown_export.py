...
"""
        ...
        with mock.patch.object(HDCASerializer, "url_for", return_value="http://google.com"):
            # Patch out serialize_store_times_summary because the datasets aren't real, just mock objects.
            with mock.patch.object(HDCASerializer, "serialize_store_times_summary", return_value=[]):
