<template>
    <div class="toolForm">
        <div class="toolFormTitle">
            Citations
            <button v-if="viewRender" v-on:click="toggleViewRender" type="button" class="btn btn-sm citations-to-bibtex" title="Show all in BibTeX format.">
                <i class="fa fa-pencil-square-o"></i>
                Show BibTeX
            </button>
            <button v-else type="button" v-on:click="toggleViewRender" class="btn btn-sm citations-to-formatted" title="Return to formatted citation list.">
