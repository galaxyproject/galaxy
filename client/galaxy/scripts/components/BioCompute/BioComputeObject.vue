...
import ObjectId from "components/BioCompute/ObjectId.vue";
import SpecVersion from "components/BioCompute/SpecVersion.vue";
import ETag from "components/BioCompute/ETag.vue";
