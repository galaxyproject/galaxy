            ...
            '<table id="grid-table" class="grid">',
                ...
                '<tbody id="grid-table-body">',
                    '<% _.each(repositories, function(repository) { %>',
                        '<tr>',
                            '<td><div id="" class=""><label id="repo-name-<%= repository.get("id") %>" for="<%= repository.get("id") %>"><%= repository.get("name") %></label></div></td>',
                            '<td><div id="" class=""><label id="repo-desc-<%= repository.get("id") %>" for="<%= repository.get("id") %>"><%= repository.get("description") %></label></div></td>',
                            '<td><div id="" class=""><label id="repo-user-<%= repository.get("id") %>" for="<%= repository.get("id") %>"><%= repository.get("owner") %></label></div></td>',
                            '<td><div id="" class=""><label id="repo-changeset-<%= repository.get("id") %>" for="<%= repository.get("id") %>"><%= repository.get("changeset_revision") %></label></div></td>',
                            '<td><div id="" class=""><label id="RepositoryStatus-<%= repository.get("id") %>" for="<%= repository.get("id") %>"><div class="repo-status count-box state-color-<%= repository.get("status").toLowerCase() %>" id="RepositoryStatus-<%= repository.get("id") %>"><%= repository.get("status") %></div></label></div></td>',
                        '</tr>',
                    '<% }); %>',
                '</tbody>',
