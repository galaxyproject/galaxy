define(
    ["mvc/dataset/dataset-model", "mvc/base-mvc", "utils/localization"],
 ...
 */
        ...
        var DCECollection = Backbone.Collection
            .extend(BASE_MVC.LoggableMixin)
            .extend(
 ...
 */
        var ListDatasetCollection = DatasetCollection.extend(
            /** @lends ListDatasetCollection.prototype */ {
                ...
                toString: function() {
                    return (
                        "List" + DatasetCollection.prototype.toString.call(this)
                    );
                }
            }
        );
 ...
 */
        var PairDatasetCollection = ListDatasetCollection.extend(
            /** @lends PairDatasetCollection.prototype */ {
                ...
                toString: function() {
                    return (
                        "Pair" + DatasetCollection.prototype.toString.call(this)
                    );
                }
            }
        );
