...
"Account registration or login": 
 	"Konto Registrierung oder Login",
"Support, contact, and community": 
 	"Unterstützung, Kontakt und Community",
"Administer this Galaxy": 
 	"Verwalte diese Galaxie",
"Visualize datasets": 
 	"Visualisieren von Datensätzen",
"Access published resources": 
 	"Zugriff auf veröffentlichte Ressourcen",
"Chain tools into workflows": 
 	"Kettenwerkzeuge in Workflows",
"Analysis home view": 
 	"Analyse home view",
// ---------------------------------------------------------------------------- histories
...
"Resume Paused Jobs": 
 	"Fortsetzen pausierte Jobs",
"Collapse Expanded Datasets": 
 	"Collapse Expanded Datasets",
"Unhide Hidden Datasets": 
 	"Hidden Datasets verstecken",
"Delete Hidden Datasets": 
 	"Hidden Datasets löschen",
"Purge Deleted Datasets": 
 	"Gelöschte Datasets löschen",
"Downloads": 
 	"Downloads",
...
"You are over your disk quota": 
 	"Du bist über dein Festplatten-Kontingent",
...
"Click to rename history": 
 	"Klicken Sie hier, um den Verlauf umzubenennen",
// multi operations
"Operations on multiple datasets": 
 	"Operationen auf mehreren Datensätzen",
"Hide datasets": 
...
"Unable to purge dataset": 
 	"Dataset kann nicht gelöscht werden",
// ---- hda-base
// display button
...
"This dataset has been hidden": 
 	"Dieser Datensatz wurde ausgeblendet",
"format": 
 	"Format",
"database": 
 	"Datenbank",
...
"Dataset is already deleted": 
 	"Dataset ist bereits gelöscht",
"View or report this error": 
 	"Diesen Fehler anzeigen oder melden",
"Run this job again": 
 	"Führen Sie diesen Job wieder",
"Visualize": 
 	"Visualisieren",
"Visualize in": 
 	"Visualize in",
...
"Permanently remove it from disk": 
 	"Permanent aus der Scheibe entfernen",
"Unhide it": 
 	"Ausblenden",
"You may be able to": 
...
"Edit dataset tags": 
 	"Dataset-Tags bearbeiten",
"Edit dataset annotation": 
 	"Datensatz-Annotation bearbeiten",
// ---------------------------------------------------------------------------- misc. MVC
"Tags": 
 	"Variablen",
"Edit annotation": 
