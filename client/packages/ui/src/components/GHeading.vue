...
import type { IconLike } from "./iconTypes";
...
const sizeClass = computed(() => `h-${props.size}`);
const collapsible = computed(() => props.collapse !== "none");
const collapsed = computed(() => props.collapse === "closed");
