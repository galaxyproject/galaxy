 ...
 * @param trsId of form `#workflow/github.com/iwc-workflows/<category>/...`
...
export async function fetchReadmeForIwcWorkflow(trsId: string) {
    try {
        ...
        const readmeUrl = `https://raw.githubusercontent.com/iwc-workflows/${category}/refs/heads/main/README.md`;
