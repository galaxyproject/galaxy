    ...
    <section>
        ...
        <div class="page-centered">
            <div v-if="currentView === 'cards'" class="row mx-auto" style="max-width: 1000px">
                <div class="col-xl-4 mb-3 mx-auto" style="max-width: 300px">
                    <BCard
                        ...
                        @click="selectView('upload')">
                        <BCardTitle>Upload file</BCardTitle>
                        <BCardBody>
                            <p class="text-muted">
                                Upload a <code>*.ga</code> file from your computer. These can be downloaded from Galaxy
                                servers, or from workflow repositories like
                                <a href="https://dockstore.org" target="_blank" rel="noopener noreferrer">Dockstore</a>
                                or
                                <a href="https://workflowhub.eu" target="_blank" rel="noopener noreferrer"
                                    >WorkflowHub</a
                                >.
                            </p>
                        </BCardBody>
                    ...
                    <BCard
                        ...
                        <BCardBody>
                            <p class="text-muted">
                                ...
                                generated by any Galaxy server, or public repositories like
            ...
            <div v-else class="d-flex flex-column flex-1">
                <div :class="currentView === 'repository' ? 'container-wide' : 'container-narrow'">
                    <p class="mb-0">
                        <BButton variant="link" class="p-0" @click="backToCards">
