            ...
            <div v-if="currentView === 'cards'" class="row mx-auto" style="max-width: 1000px">
                <div class="col-xl-4 mb-3 mx-auto" style="max-width: 300px">
                    <BCard class="h-100 workflow-import-file-link clickable-card text-center" @click="selectView('upload')">
                        ...
                        <BCardBody>
                            <p class="text-muted">
                                Upload a <code>*.ga</code> file from your computer. These can be downloaded from Galaxy servers, or from workflow repositories like
                                <a href="https://dockstore.org" target="_blank" rel="noopener noreferrer">Dockstore</a>
                                or
                                <a href="https://workflowhub.eu" target="_blank" rel="noopener noreferrer">WorkflowHub</a>.
                            </p>
                        </BCardBody>
                    </BCard>
                </div>
                ...
                <div class="col-xl-4 mb-3 mx-auto" style="max-width: 300px">
                    <BCard class="h-100 workflow-import-trs-search-link clickable-card text-center" @click="selectView('fetch')">
                        ...
                        <BCardBody>
                            <p class="text-muted">
                                Fetch a remote <code>*.ga</code> file from any publicly accessible URL. These can be generated by any Galaxy server, or public repositories like
