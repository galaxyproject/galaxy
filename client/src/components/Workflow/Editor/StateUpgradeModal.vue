...
<template>
    <GModal :show.sync="show" :title="title" size="medium" fixed-height>
        <div v-if="show" class="state-upgrade-modal" data-description="workflow state upgrade modal content">
            {{ message }}
