<template>
    <div v-if="workflow">
        ...
        <div v-if="workflow.importable && workflow.slug">
            ...
            <div>
                <small>
                    Use this URL to import the workflows directly into another Galaxy server. You can copy it into the
                    input field titled when importing a workflow.
                </small>
            </div>
            <hr />
        </div>
        <b-alert v-else variant="info" show>
            This workflow is not accessible. Please use the sharing option to "Make Workflow Accessible and Publish" to
            obtain a URL for importing to another Galaxy.
        </b-alert>
