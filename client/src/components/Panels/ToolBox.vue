        ...
        <div unselectable="on">
            <div class="unified-panel-header-inner">
                <nav class="d-flex justify-content-between mx-3 my-2">
                    <h2 v-if="!showAdvanced" v-localize id="toolbox-heading" class="m-1 h-small">Tools</h2>
                    <h2 v-else v-localize id="toolbox-heading" class="m-1 h-small">Advanced Tool Search</h2>
