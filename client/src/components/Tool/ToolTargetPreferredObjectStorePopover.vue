<template>
    <b-popover target="tool-storage" triggers="hover" placement="bottomleft">
        ...
        <p v-if="toolPreferredObjectStoreId">
            This target storage location has been set at the tool level, by default history or user preferences will be
        ...
        <div v-localize>
            Change this preference storage location target by clicking on the storage button in the tool header.
        </div>
    </b-popover>
</template>
