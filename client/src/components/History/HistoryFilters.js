...
export const validFilters = {
    ...
    hid_gt: { handler: compare("hid", "gt"), menuItem: false },
    hid_le: { handler: compare("hid", "le"), menuItem: false },
    hid_lt: { handler: compare("hid", "lt"), menuItem: false },
    create_time: {
    ...
    create_time_gt: { handler: compare("create_time", "gt", toDate), menuItem: false },
    create_time_le: { handler: compare("create_time", "le", toDate), menuItem: false },
    create_time_lt: { handler: compare("create_time", "lt", toDate), menuItem: false },
    deleted: {
        placeholder: "Deleted",
        type: Boolean,
        options: options,
