        ...
        <nav class="d-flex justify-content-between mx-3 my-2">
            ...
            <b-button-group>
                <b-button
                    ...
                    <FontAwesomeIcon fixed-width icon="plus" />
                </b-button>
                ...
                <b-button
                    ...
                    <FontAwesomeIcon fixed-width icon="exchange-alt" />
                </b-button>
                ...
                <b-dropdown
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="columns" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="play" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="stream" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="file-archive" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="file-export" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="share-alt" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="user-lock" class="mr-1" />
                    ...
                    <b-dropdown-item
                        ...
                        <FontAwesomeIcon fixed-width icon="lock" class="mr-1" />
