    ...
    >
        ...
        <nav class="p-1 d-flex align-items-center cursor-pointer" @click.stop="$emit('update:expanded', !expanded)">
            <div class="d-flex align-items-center flex-grow-1 overflow-hidden">
                ...
                <StatusIcon v-if="!collapsed" class="status-icon px-1" :state="ITstate" @click.stop="onStatusClick" />
            ...
            <div class="d-flex">
                <slot name="menu">
                    <InteractiveToolMenu :dataset="dataset" :expanded="expanded" v-on="$listeners" />
                </slot>
            </div>
        </nav>
