...
const stateText = computed(() => props.dataset.state && (states[props.dataset.state] as State)?.text);
</script>

<template>
    <div v-if="!isLoading" class="dataset">
        <div class="p-2 details not-loading">
            ...
            <DatasetActions
                ...
                :item-urls="itemUrls"
                @toggleHighlights="() => emit('toggleHighlights')" />
