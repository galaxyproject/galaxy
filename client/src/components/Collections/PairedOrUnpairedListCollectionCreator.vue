...
import { type ColDef, type GetRowIdParams, type NewValueParams } from "ag-grid-community";
...
interface RowT {
    id: string;
    datasets: GenericPair<HistoryItemSummary> | { unpaired: HistoryItemSummary };
    identifier: string;
                    ...
                    <BRow v-if="!flatLists">
                        <BCol>
                            <BAlert show variant="info" dismissible>
                                ...
                                <BLink style="font-weight: bold" @click="goToAutoPairing"
                                    >configure auto-filtering</BLink
                                >.
                            </BAlert>
                        </BCol>
                    </BRow>
                    <BRow v-if="unpairedProblemDatasetCount > 0">
                        <BCol>
                            <BAlert show variant="warning" dismissible>
                                ...
                                or paired off.
                                <BLink style="font-weight: bold" @click="dismissUnmatchedDatasets"
                                    >Click here to dismiss.</BLink
                                >
                            </BAlert>
                        </BCol>
                    </BRow>
