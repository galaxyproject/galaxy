        ...
        <rule-modal-middle v-else>
            ...
            >
                ...
                <div class="rule-column" :class="orientation">
                    ...
                    >
                        <rule-component rule-type="sort" :displayRuleType.sync="this.displayRuleType" :builder="this">
                        ...
                        <rule-component
                            ...
                            :displayRuleType.sync="this.displayRuleType"
                            :builder="this"
                        >
                            <column-selector
                        ...
                        <rule-component rule-type="remove_columns" :displayRuleType.sync="this.displayRuleType" :builder="this">
                            <column-selector
                        ...
                        <rule-component rule-type="split_columns" :displayRuleType.sync="this.displayRuleType" :builder="this">
                            <column-selector
                        ...
                        <rule-component rule-type="swap_columns" :displayRuleType.sync="this.displayRuleType" :builder="this">
                            <column-selector
