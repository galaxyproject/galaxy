...
export default {
    ...
    Histories: "Historiques",
    // ---------------------------------------------------------------------------- shed-list-view
    "Configured Tool Sheds": "Tool Sheds configurés",
    ...
    // ---------------------------------------------------------------------------- form-repeat
    "Delete this repeat block": "Supprimer ce bloc de répétition",
    ...
    // ---------------------------------------------------------------------------- default-view
    "FTP files": "Fichiers FTP",
    Reset: "Réinitialiser",
    Pause: "Pause",
    Start: "Commencer",
    "Choose FTP file": "Choisissez un fichier FTP",
    "Choose local file": "Choisissez un fichier local",
    // ---------------------------------------------------------------------------- collection-view
    Build: "Construire",
    ...
    "Close visualization": "Fermer la visualisation",
    Circster: false,
    Bookmarks: "Signets",
    "Add group": "Ajouter un groupe",
    // ---------------------------------------------------------------------------- sweepster
    "Remove parameter from tree": "Supprimer le paramètre de l'arbre",
    ...
    Tool: "Outil",
    "Set as overview": "Définir comme aperçu",
    ...
    // ---------------------------------------------------------------------------- generic-nav-view
    "Chat online": "Discuter en ligne",
    // ---------------------------------------------------------------------------- ui-select-content
    "Multiple collections": "Plusieurs collections",
    "Dataset collections": "Collections de jeux de données",
    "Dataset collection": "Collection de jeu de données",
