...
_TagSelector = _TagName | Collection[_TagSelector] | Any
...
_XPathObject = (
    ...
    | list[
        Union[
            ...
            _AnySmartStr,
            _AnyStr,
            tuple[_AnyStr | None, _AnyStr | None],
        ]
    ]
)
_AnyParser = "XMLParser" | "HTMLParser"
_ListAnyStr = list[str] | list[bytes]
_DictAnyStr = dict[str, str] | dict[bytes, bytes]
_Dict_Tuple2AnyStr_Any = dict[tuple[str, str], Any] | tuple[bytes, bytes] | Any
_xpath = "XPath" | _AnyStr
...
_FileSource = _AnyStr | IO[Any] | PathLike[Any]
...
class DocInfo:
    ...
    def __init__(self, tree: _ElementTree | _Element) -> None: ...
    def clear(self) -> None: ...
...
class _Element(Iterable["_Element"], Sized):
    ...
    def find(self, path: str, namespaces: _NSMapArg | None = ...) -> _Element | None: ...
    @overload
    def findtext(
        self,
        path: str,
    ...
    def findall(self, path: str, namespaces: _NSMapArg | None = ...) -> list[_Element]: ...
    def clear(self) -> None: ...
    @overload
    ...
    def index(self, child: _Element, start: int | None = ..., stop: int | None = ...) -> int: ...
    def insert(self, index: int, element: _Element) -> None: ...
    def items(self) -> Sequence[tuple[_AnyStr, _AnyStr]]: ...
    def iter(self, tag: _TagSelector | None = ..., *tags: _TagSelector) -> Iterator[_Element]: ...
    iterancestors = iter
    def iterchildren(
        self,
    ...
    def iterfind(self, path: str, namespaces: _NSMapArg | None = ...) -> Iterator[_Element]: ...
    def itersiblings(
        self,
        tag: _TagSelector | None = ...,
        *tags: _TagSelector,
...
class _ElementTree:
    ...
    def xslt(
        self,
        _xslt: XSLT,
        extensions: _Dict_Tuple2AnyStr_Any | None = ...,
...
class _Attrib:
    ...
    def __len__(self) -> int: ...
    def get(self, key: _AnyStr, default: _AnyStr | None = ...) -> _AnyStr | None: ...
...
class QName:
    ...
    def __init__(
        self,
        text_or_uri_element: None | (_AnyStr | _Element),
        tag: _AnyStr | None = ...,
    ) -> None: ...
...
class CustomElementClassLookup(FallbackElementClassLookup):
    def lookup(self, type: str, doc: str, namespace: str, name: str) -> type[ElementBase] | None: ...
...
class Resolver:
    ...
    def resolve_file(self, f: IO[Any], context: Any, *, base_url: _AnyStr | None, close: bool): ...
    def resolve_string(self, string: _AnyStr, context: Any, *, base_url: _AnyStr | None): ...
...
def ProcessingInstruction(target: _AnyStr, text: _AnyStr = ...) -> _ProcessingInstruction: ...
...
def tostring(
    ...
    encoding: _KnownEncodings | None = None,
    method: str = ...,
    xml_declaration: bool = ...,
    pretty_print: bool = ...,
    with_tail: bool = ...,
...
class XPath(_XPathEvaluatorBase):
    ...
    def __call__(self, _etree_or_element: _ElementOrTree, **_variables: _XPathObject) -> _XPathObject: ...
    path = ...  # type: str
...
class TreeBuilder:
    def __init__(
        ...
        comment_factory: _CommentFactory | None = ...,
        pi_factory: _ProcessingInstructionFactory | None = ...,
...
_ParseEventType: TypeAlias = Literal["start", "end", "start-ns", "end-ns", "comment", "pi"]
_ParseEvent: TypeAlias = tuple[Literal["start"], _Element] | (
    tuple[Literal["end"], _Element]
    | (
        tuple[Literal["start-ns"], tuple[_AnyStr, _AnyStr]]
        | (
            tuple[Literal["end-ns"], None]
            | (tuple[Literal["comment"], _Comment] | tuple[Literal["pi"], _ProcessingInstruction])
        )
    )
)
...
class XMLPullParser(XMLParser):
    def __init__(
        self,
        events: Iterable[_ParseEventType] | None = ...,
        *,
        tag: _TagSelector | None = ...,
        base_url: _AnyStr | None = ...,
        encoding: _AnyStr | None = ...,
