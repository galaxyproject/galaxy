...
var PeptideView = (function (pv) {
    ...
    pv.appendDetailDOM = function (sequence) {
        ...
        el.append($.parseHTML('<div class="panel panel-default"> ' +
            ...
            '<div class="row">' +
            '<div class="col-md-10"><h3 class="panel-title" style="display: inline;">PSM Detail for ' + sequence + '</h3><span id="psm_detail_help" class="fa fa-question" style="padding: 5px"></span><span class="sr-only">Help?</span></div>' +
...
var ScoreFilterModule = (function(sfm){
    ...
    sfm.buildScoreFilterRow = function(sName){
        ...
        divStr += '<div class="col-md-2"><input class="sf-number" type="number"></div><div class="col-md-1"><span delete-row="' + rId + '" class="filter-remove" aria-hidden="true">X</span></div>';
...
var featureViewer = {
    ...
    buildFeatures: function (data) {
        ...
        $('#protein_viewer').prepend('<button type="button" id="clear_map" class="btn btn-primary btn-sm">Clear Map</button><span id="fv_help"  class="fa fa-question" style="padding: 5px"></span>');
