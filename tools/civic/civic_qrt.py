...
def render(line,civic_variant,host,entrez_id_column):
  ...
  (variant_name,drugs,link,expected_hgvs) = civic_properties(line,civic_variant,host,entrez_id_column)

  if (render_header):
     print( '<html>\n<head>\n<title>Galaxy - CIViC Links</title>\n<link rel="stylesheet" href="/static/style/base.css" type="text/css" />\n</head>\n<body>\n  <p/>\n  <table>\n    <CAPTION>Galaxy - Civic Links</CAPTION><thead>\n      <tr>\n' )
...
def civic_properties(line,response,host,entrez_id_column):
  ...
  if (response):    
    ...
    link = '<a href="http://{}/#/events/genes/{}/summary">civic gene</a>'.format(host,civic_id)
  ...
  return [variant_name,drugs,link,expected_hgvs]
