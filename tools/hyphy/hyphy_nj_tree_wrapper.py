...
temp_ps_filename = hyphy_util.get_filled_temp_filename( "", directory=tmp_file_dir )
...
NJ_tree_shared_ibf = hyphy_util.get_filled_temp_filename( hyphy_util.NJ_tree_shared_ibf, directory=tmp_file_dir )

#set up NJ_tree file
NJ_tree_filename = hyphy_util.get_filled_temp_filename( hyphy_util.get_NJ_tree( NJ_tree_shared_ibf ), directory=tmp_file_dir )
#setup Config file
...
if is_multiple: 
    ...
    NJ_tree_filename = hyphy_util.get_filled_temp_filename( hyphy_util.get_NJ_treeMF( NJ_tree_shared_ibf ), directory=tmp_file_dir )
