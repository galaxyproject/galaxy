...
def __main__():
    ...
    parser.add_option( '--i1', '--file_id_1', dest='file_id_1', action='store', type="string", default=None, help='file_id_1')
    parser.add_option( '--f2', '--file_id_2', dest='file_id_2', action='store', type="string", default=None, help='file_id_2')
