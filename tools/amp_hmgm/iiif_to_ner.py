...
# Usage: iiif_to_ner.py from_iiif original_ner to_ner
def main():
    ...
    to_ner = sys.argv[4]        # json file to feed to downstream MGMs in standard AMP NER format to convert to
    ...
    try:
        ...
        print("Converting corrected IIIF " + from_iiif + " to corrected NER " + to_ner)
